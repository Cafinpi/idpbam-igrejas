<%@ control language="C#" autoeventwireup="true" inherits="COMPONENTS.GEditor, App_Web_nntdyv20" %>
...
<asp:Panel runat="server" ClientIDMode="Static" ID="ContentEditor">
    <telerik:RadEditor ID="Editor" runat="server" EnableResize="false" CssClass="Editor" EditModes="Design,Html">
        <Tools>
