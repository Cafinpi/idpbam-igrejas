<%@ control language="C#" autoeventwireup="true" inherits="PROJETO.SidebarPage, App_Web_f5ywt1b4" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
	<meta name="generator" content="Gvinci Low-Code Platform" />
	<telerik:RadCodeBlock ID="CustomHeaderCodeBlock" runat="server">
		<link rel="stylesheet" href="0240312113343erência: Nenhuma" type="text/css" media="screen" title="no title" charset="utf-8" />
