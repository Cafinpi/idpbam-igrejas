<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.PagarReeberPage, App_Web_pvpeziro" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/PagarReeberPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/PagarReeberPage_USER.js?sv=4.0_20240309131819"></script>
	...
	<script type="text/javascript">
		...
		function txtValor_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
								...
								<div id="LayoutRow2" class="row c_LayoutRow2 card flex-row">
									<div id="LayoutCol20" class="col col-12 c_LayoutCol20 card-header">
										<div id="Div1" runat="server" class="c_Div1 div-transparent">
											...
											<telerik:RadButton id="Button22" runat="server" ButtonType="SkinnedButton" CssClass="c_Button22 button-primary" CommandName="Button22"
												OnClientClicking="___Button22_OnClientClick" RenderMode="Lightweight" TabIndex="2">
												<ContentTemplate>
													<span class="gvText"></span>
													<span class="fas fa-trash c_Button22_icon gvIcon"></span>
												</ContentTemplate>
											</telerik:RadButton>
										</div>
									</div>
										...
										<div id="LayoutRow4" class="row c_LayoutRow4">
											...
											<div id="LayoutCol4" class="col col-12 col-sm-6 col-md-4 c_LayoutCol4">
												...
												<telerik:RadTextBox id="txtDescricao" runat="server" AutoPostBack="False" CssClass="c_txtDescricao textbox-default"
													...
													onkeydown="___txtDescricao_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="3" TextMode="SingleLine"
											...
											<div id="LayoutCol31" class="col col-12 col-md-3 c_LayoutCol31">
												...
												<telerik:RadComboBox id="ComboBox3" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													...
													data-validation-engine="validate[funcCall[ComboBox3_Validation]]" data-validation-message="GC_ID não pode ser vazio!"
											...
											<div id="LayoutCol7" class="col col-12 col-sm-6 col-md-3 c_LayoutCol7">
												...
												<telerik:RadComboBox id="CBCategoria" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													...
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBCategoria_OnItemsRequested" RenderMode="Lightweight" TabIndex="6" />
											...
											<div id="LayoutCol8" class="col col-12 col-sm-6 col-md-3 c_LayoutCol8">
												...
												<telerik:RadComboBox id="CBConta" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													...
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBConta_OnItemsRequested" RenderMode="Lightweight" TabIndex="7" />
											...
											<div id="LayoutCol9" class="col col-12 col-sm-6 col-md-3 c_LayoutCol9">
												...
												<telerik:RadTextBox id="txtValor" runat="server" AutoPostBack="False" CssClass="c_txtValor textbox-default"
													data-validation-engine="validate[funcCall[txtValor_Validation]]" data-validation-message="LANC_VALOR não pode ser vazio!"
											...
											<div id="LayoutCol22" class="col col-12 col-md-3 c_LayoutCol22">
												...
												<gas:GMultiMedia id="GMultiMedia1" runat="server" AllowFileExtensions="jpg,png,bmp,pdf" AmazonAccessKey="AKIA4VJOWCUN4NV5NTVO"
													...
													Path="~/Images/Financeiro/" Responsive="true" SaveAsFile="True" SaveOnS3="True" SessionHandlerObjectName="nota_recibo35623"
													ShowDownloadLink="False" ShowImage="False" TabIndex="10" Visible="True" Width="100%" />
											</div>
											<div id="LayoutCol14" class="col col-12 col-sm-2 offset-0 offset-sm-0 offset-md-8 offset-lg-0 offset-xl-8 c_LayoutCol14">
											</div>
											<div id="LayoutCol16" class="col col-12 col-md-2 c_LayoutCol16">
												<telerik:RadButton id="Button18" runat="server" ButtonType="SkinnedButton"
													...
													OnClientClicking="___Button18_OnClientClick" RenderMode="Lightweight" TabIndex="11" Text="<%$ Resources: Button18 %>">
													<ContentTemplate>
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function GC_ID() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
		...
		function EnableButtons()
		{
				try
				{
					...
					try { __PAGECOUNT = parseInt(document.getElementById("__PAGECOUNT").value); } catch (e) { }
						$find("Button22").set_enabled(!(IsAjaxProcessing || !(__PAGECOUNT > 0 && __ALLOWREMOVE == "true" && __ISPARAMETER == "false")));
