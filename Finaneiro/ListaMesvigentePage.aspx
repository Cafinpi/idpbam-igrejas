<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaMesvigentePage, App_Web_ye34v321" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaMesvigentePage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../JS/ListaMesvigentePage_USER.js?sv=4.0_20240312113335"></script>
	...
	<script type="text/javascript">
		...
		function GridColumn_mesReferencia_Validation(field, rules, i, options) {
									...
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="mesReferencia,anoReferencia" EditMode="InPlace">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn_mesReferencia" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%"
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_mesReferencia" HeaderStyle-Width="273"
														HeaderText="<%$ Resources: GridColumn_mesReferencia %>" ItemStyle-CssClass="c_GridColumn_mesReferencia" ItemStyle-Width="266"
													...
													<telerik:GridBoundColumn UniqueName="GridColumn_anoReferencia" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_anoReferencia" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn_anoReferencia %>" ItemStyle-CssClass="c_GridColumn_anoReferencia"
														ItemStyle-HorizontalAlign="Right" ItemStyle-Width="86" MaxLength="10" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridCheckBoxColumn UniqueName="GridColumn_mesAtivo" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" EnableHeaderContextMenu="True" Exportable="True" FilterDelay="2000"
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_mesAtivo" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn_mesAtivo %>" ItemStyle-CssClass="c_GridColumn_mesAtivo" ItemStyle-Width="86" ReadOnly="False"
