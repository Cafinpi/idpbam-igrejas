<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.destinoofertamissoes, App_Web_hpcuywwe" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/destinoofertamissoes.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       text: customMessage === undefined ? 'A soma do percentual ultrapassa 100% de divisão!' : customMessage,
		...
		<script type="text/javascript" src="../JS/destinoofertamissoes_USER.js?sv=4.0_20240312113327"></script>
	...
	<script type="text/javascript">
		...
		function ___RadTextBox_OFERTA_DESTINO_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		function ___RadTextBox_PERC_DESTINO_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		...
		function ___TxtSomaPercentual_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		function RadTextBox_OFERTA_DESTINO_Validation(field, rules, i, options) {
		...
		function RadTextBox_PERC_DESTINO_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
					...
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Configurar destino oferta missões" />
							</div>
						</div>
						<div id="LayoutRow2" class="row c_LayoutRow2">
							<div id="LayoutCol2" class="col col-12 col-md-5 c_LayoutCol2">
								<telerik:RadLabel id="Label_OFERTA_DESTINO" runat="server" CssClass="c_Label_OFERTA_DESTINO" Text="<%$ Resources: Label_OFERTA_DESTINO %>" />
								<telerik:RadTextBox id="RadTextBox_OFERTA_DESTINO" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_OFERTA_DESTINO textbox-default"
									data-validation-engine="validate[funcCall[RadTextBox_OFERTA_DESTINO_Validation]]"
									data-validation-message="OFERTA_DESTINO não pode ser vazio!" EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True"
									ForeColor="#333333" MaxLength="500" onkeydown="___RadTextBox_OFERTA_DESTINO_onkeydown();" ReadOnly="False" RenderMode="Lightweight"
									TabIndex="1" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_RadTextBox_OFERTA_DESTINO_wrapper" />
							</div>
							<div id="LayoutCol3" class="col col-12 col-md-2 c_LayoutCol3">
								<telerik:RadLabel id="Label_PERC_DESTINO" runat="server" CssClass="c_Label_PERC_DESTINO" Text="<%$ Resources: Label_PERC_DESTINO %>" />
								<telerik:RadTextBox id="RadTextBox_PERC_DESTINO" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_PERC_DESTINO textbox-default"
									data-validation-engine="validate[funcCall[RadTextBox_PERC_DESTINO_Validation]]" data-validation-message="PERC_DESTINO não pode ser vazio!"
									EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="11"
									onkeydown="___RadTextBox_PERC_DESTINO_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="2" TextMode="SingleLine"
									UseTelerikMask="False" WrapperCssClass="c_RadTextBox_PERC_DESTINO_wrapper" />
							</div>
							<div id="LayoutCol8" class="col col-12 col-md-5 c_LayoutCol8">
								...
								<telerik:RadComboBox id="ComboBox2" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[ComboBox2_Validation]]" data-validation-message="GC_ID não pode ser vazio!"
						...
						<div id="LayoutRow3" class="row c_LayoutRow3">
							<div id="LayoutCol5" class="col col-12 col-md-2 offset-0 offset-sm-0 offset-md-8 offset-lg-8 offset-xl-8 c_LayoutCol5">
								<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton"
									...
									RenderMode="Lightweight" TabIndex="7" Text="<%$ Resources: Button2 %>">
									<ContentTemplate>
										<span class="gvText">Novo</span>
										<span class="fas fa-plus c_Button2_icon gvIcon"></span>
									</ContentTemplate>
								</telerik:RadButton>
								<telerik:RadTextBox id="TxtSomaPercentual" runat="server" AutoPostBack="False" CssClass="c_TxtSomaPercentual textbox-default"
									EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0"
									onkeydown="___TxtSomaPercentual_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="5" TextMode="SingleLine"
									UseTelerikMask="False" WrapperCssClass="c_TxtSomaPercentual_wrapper" />
							</div>
							<div id="LayoutCol9" class="col col-12 col-md-2 c_LayoutCol9">
								<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton"
									...
									<ContentTemplate>
										...
										<span class="fas fa-save c_Button1_icon gvIcon"></span>
									</ContentTemplate>
								</telerik:RadButton>
							</div>
							<div id="LayoutCol7" class="col col-12 c_LayoutCol7">
								<telerik:RadGrid id="Grid_TB_PARAM_OFERTA_MISSAO" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True"
									...
									OnDeleteCommand="Grid_DeleteCommand" OnInit="Grid_Init" OnInsertCommand="Grid_InsertCommand"
									OnItemCommand="Grid_TB_PARAM_OFERTA_MISSAO_ItemCommand" OnItemCreated="Grid_TB_PARAM_OFERTA_MISSAO_ItemCreated"
									OnItemDataBound="Grid_TB_PARAM_OFERTA_MISSAO_ItemDataBound" OnNeedDataSource="Grid_NeedDataSource" OnUpdateCommand="Grid_UpdateCommand"
									PageSize="10" RenderMode="Lightweight" ShowFooter="False" ShowGroupPanel="False" TabIndex="3" TableLayout="Fixed">
									<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="IDFERTAMISSAO" EditMode="InPlace">
										<Columns>
											<telerik:GridBoundColumn UniqueName="GridColumn_OFERTA_DESTINO" runat="server" AllowFiltering="True" AllowSorting="true"
												...
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_OFERTA_DESTINO"
											...
											<telerik:GridBoundColumn UniqueName="GridColumn_CAT_ID" runat="server" AllowFiltering="True" AllowSorting="true"
												...
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_CAT_ID" HeaderStyle-Width="93"
												HeaderText="<%$ Resources: GridColumn_CAT_ID %>" ItemStyle-CssClass="c_GridColumn_CAT_ID" ItemStyle-Width="86" MaxLength="255"
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#RadTextBox_OFERTA_DESTINO').first().focus();", 200);
				}
			}
			catch (e)
			{
		...
		function OFERTA_DESTINO() { return document.getElementById('RadTextBox_OFERTA_DESTINO').value; }
		function PERC_DESTINO() { return document.getElementById('RadTextBox_PERC_DESTINO').value; }
		function GC_ID() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function __TxtSomaPercentual() { return document.getElementById('TxtSomaPercentual').value; }
		function EnableButtons()
		{
				try
				{
					...
					try { __PAGECOUNT = parseInt(document.getElementById("__PAGECOUNT").value); } catch (e) { }
						$find("Button2").set_enabled(!(IsAjaxProcessing || !(__PAGESTATE == "navigation" && __ALLOWINSERT == "true" && __ISPARAMETER == "false")));
					try
					{
		...
		function LoadEditAuto() {
				$j("#RadTextBox_OFERTA_DESTINO").bind("keydown", InitiateEditAuto);
				$j("#RadTextBox_PERC_DESTINO").bind("keydown", InitiateEditAuto);
