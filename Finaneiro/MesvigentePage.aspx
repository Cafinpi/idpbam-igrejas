<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.MesvigentePage, App_Web_foeupi1h" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/MesvigentePage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       icon:  'question' ,
	       title: customTitle === undefined ? 'Confirma abertura do mês selecionado?' : customTitle,
	...
	function sweetAlert_SweetAlert2(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       icon:  'warning' ,
	       title: customTitle === undefined ? 'O mês selecionado já foi aberto!' : customTitle,
	       text: customMessage === undefined ? 'Deseja reabrir o mês?' : customMessage,
	       showCloseButton:  false,
	       showCancelButton: true,
	       showConfirmButton:true,
	       confirmButtonText:'SIM' ,
	...
	function sweetAlert_SweetAlert3(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       icon:  'info' ,
	       title: customTitle === undefined ? 'MÊS SELECIONADO FECHADO PELA IDPB ESTADUAL!' : customTitle,
	       text: customMessage === undefined ? '' : customMessage,
	       showCloseButton:  false,
		...
		<script type="text/javascript" src="../JS/MesvigentePage_USER.js?sv=4.0_20240403133330"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/ListaMesvigentePage.aspx") %>';
			Navigate(UrlPage, false);
			args.set_cancel(true);
			return false;
		}
		function ___CBMesReferencia_OnBlur(sender)
		{
		...
		function GridColumn_mesExtensoReferencia_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function GridColumn_anoReferencia_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function CBMesReferencia_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function txtAno_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
									...
									<div id="LayoutCol19" class="col col-12 c_LayoutCol19 card-header">
										<div id="Div2" runat="server" class="c_Div2 div-transparent">
											...
											<telerik:RadButton id="Button23" runat="server" ButtonType="SkinnedButton" CssClass="c_Button23 button-primary" CommandName="Button23"
												OnClick="___Button23_OnClick" RenderMode="Lightweight" TabIndex="2">
												<ContentTemplate>
													<span class="gvText"></span>
													<span class="fas fa-sync c_Button23_icon gvIcon"></span>
												</ContentTemplate>
											</telerik:RadButton>
										</div>
									</div>
									<div id="LayoutCol20" class="col col-12 c_LayoutCol20 card-body">
										<div id="LayoutRow5" class="row c_LayoutRow5">
											<div id="LayoutCol21" class="col col-12 col-md-8 c_LayoutCol21">
												...
												<telerik:RadComboBox id="CBMesReferencia" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_CBMesReferencia combobox-secondary" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[CBMesReferencia_Validation]]" data-validation-message="mesReferencia não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#FFD86B" LoadingMessage="<%$ Resources: CBMesReferencia %>" MarkFirstMatch="true" MaxHeight="300"
													OnClientBlur="___CBMesReferencia_OnBlur" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBMesReferencia_OnItemsRequested" RenderMode="Lightweight" TabIndex="4" />
											...
											<div id="LayoutCol3" class="col col-12 col-md-2 c_LayoutCol3">
												...
												<telerik:RadTextBox id="txtAno" runat="server" AutoPostBack="False" CssClass="c_txtAno textbox-default"
													data-validation-engine="validate[funcCall[txtAno_Validation]]" data-validation-message="mesAtivo não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="10"
													onkeydown="___txtAno_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="3" TextMode="SingleLine" UseTelerikMask="False"
													WrapperCssClass="c_txtAno_wrapper" />
											...
											<div id="LayoutCol22" class="col col-12 col-md-2 c_LayoutCol22">
												<telerik:RadButton id="Button24" runat="server" ButtonType="SkinnedButton"
													...
													RenderMode="Lightweight" TabIndex="6" Text="<%$ Resources: Button24 %>">
													<ContentTemplate>
														<span class="gvText">ABRIR</span>
											...
											<div id="LayoutCol10" class="col col-12 c_LayoutCol10">
												...
												<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
													...
													<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="mesReferencia,anoReferencia" EditMode="InPlace">
														<Columns>
															<telerik:GridBoundColumn UniqueName="GridColumn_mesExtensoReferencia" runat="server" AllowFiltering="True" AllowSorting="true"
																AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="Mes" EnableHeaderContextMenu="True" Exportable="True"
																FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_mesExtensoReferencia"
																HeaderStyle-Width="229" HeaderText="<%$ Resources: GridColumn_mesExtensoReferencia %>"
																ItemStyle-CssClass="c_GridColumn_mesExtensoReferencia" ItemStyle-Width="222" MaxLength="10" ReadOnly="False" ShowFilterIcon="True"
																ShowSortIcon="True" />
															<telerik:GridBoundColumn UniqueName="GridColumn_anoReferencia" runat="server" AllowFiltering="True" AllowSorting="true"
																AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="anoReferencia" DataFormatString="{0:#########0}"
																EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%" FilterDelay="2000" FooterStyle-HorizontalAlign="Right"
																ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_anoReferencia" HeaderStyle-HorizontalAlign="Right"
																HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_anoReferencia %>" ItemStyle-CssClass="c_GridColumn_anoReferencia"
																ItemStyle-HorizontalAlign="Right" ItemStyle-Width="86" MaxLength="10" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
														</Columns>
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function mesReferencia() { return $find("<%= CBMesReferencia.ClientID %>").get_value(); }
		function __RadTextBox1() { return document.getElementById('RadTextBox1').value; }
		function anoReferencia() { return document.getElementById('txtAno').value; }
		function __RadTextBox2() { return document.getElementById('RadTextBox2').value; }
