<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.CCPrestadorServicoPage, App_Web_l2xdquqw" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/CCPrestadorServicoPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../../JS/CCPrestadorServicoPage_USER.js?sv=4.0_20240325151734"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/CentroCusto/CCPrestadorServicoPage.aspx?ParamCORID={ParamCORID}") %>';
			UrlPage = UrlPage.replace('{ParamCORID}', '');
								...
								<div id="LayoutRow2" class="row c_LayoutRow2 card flex-row">
									...
									<div id="LayoutCol20" class="col col-12 c_LayoutCol20 card-body">
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol22" class="col col-12 col-md-3 col-lg-12 c_LayoutCol22">
												...
												<telerik:RadComboBox id="ComboBox2" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox2 combobox-primary"
													...
													LoadingMessage="<%$ Resources: ComboBox2 %>" MarkFirstMatch="true" MaxHeight="100"
											...
											<div id="LayoutCol4" class="col col-12 col-sm-6 col-md-4 col-lg-6 col-xl-10 c_LayoutCol4">
												...
												<telerik:RadTextBox id="txtNome" runat="server" AutoPostBack="False" CssClass="c_txtNome textbox-default"
													data-validation-engine="validate[funcCall[txtNome_Validation]]" data-validation-message="COR_NOME não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="200"
													onkeydown="___txtNome_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="4" TextMode="SingleLine" UseTelerikMask="False"
													WrapperCssClass="c_txtNome_wrapper" />
												<telerik:RadLabel id="Label6" runat="server" CssClass="c_Label6" Text="<%$ Resources: Label6 %>" />
											</div>
											<div id="LayoutCol21" class="col col-12 col-md-2 col-lg-12 c_LayoutCol21">
												...
												<telerik:RadDatePicker id="DatePicker1" runat="server" CssClass="c_DatePicker1 datepicker-default"
													...
													TabIndex="5" Width="1126" />
											</div>
											<div id="LayoutCol23" class="col col-12 col-md-3 col-lg-12 c_LayoutCol23">
												...
												<telerik:RadTextBox id="RadTextBox9" runat="server" AutoPostBack="False" CssClass="c_RadTextBox9 textbox-default"
													...
													onkeydown="___RadTextBox9_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="6" TextMode="SingleLine"
													UseTelerikMask="False" WrapperCssClass="c_RadTextBox9_wrapper" />
											</div>
											<div id="LayoutCol7" class="col col-12 col-sm-6 col-md-3 col-lg-6 col-xl-2 c_LayoutCol7">
												...
												<telerik:RadComboBox id="CBTipo" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_CBTipo combobox-primary"
													...
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBTipo_OnItemsRequested" RenderMode="Lightweight" TabIndex="7" />
												<telerik:RadLabel id="Label10" runat="server" CssClass="c_Label10" Text="<%$ Resources: Label10 %>" />
											</div>
											<div id="LayoutCol8" class="col col-12 col-sm-6 col-md-3 col-lg-6 col-xl-10 c_LayoutCol8">
												...
												<telerik:RadTextBox id="txtNumDoc" runat="server" AutoPostBack="False" CssClass="c_txtNumDoc textbox-default"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="50"
													onkeydown="___txtNumDoc_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="8" TextMode="SingleLine" UseTelerikMask="False"
											...
											<div id="LayoutCol9" class="col col-12 col-sm-6 c_LayoutCol9">
												...
												<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" CssClass="c_RadTextBox2 textbox-default"
													...
													onkeydown="___RadTextBox2_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="9" TextMode="SingleLine"
													UseTelerikMask="False" WrapperCssClass="c_RadTextBox2_wrapper" />
											</div>
											<div id="LayoutCol10" class="col col-12 col-sm-6 c_LayoutCol10">
												...
												<telerik:RadTextBox id="RadTextBox5" runat="server" AutoPostBack="False" CssClass="c_RadTextBox5 textbox-default"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="100"
													onkeydown="___RadTextBox5_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="10" TextMode="SingleLine"
													UseTelerikMask="False" WrapperCssClass="c_RadTextBox5_wrapper" />
											</div>
											<div id="LayoutCol11" class="col col-12 col-sm-6 col-md-3 col-lg-6 c_LayoutCol11">
											...
											<div id="LayoutCol12" class="col col-12 col-sm-6 col-md-3 col-lg-6 c_LayoutCol12">
												...
												<telerik:RadTextBox id="RadTextBox7" runat="server" AutoPostBack="False" CssClass="c_RadTextBox7 textbox-default"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="100"
													onkeydown="___RadTextBox7_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="12" TextMode="SingleLine"
											...
											<div id="LayoutCol18" class="col col-12 col-md-2 col-lg-12 offset-0 offset-sm-0 offset-md-8 offset-lg-0 offset-xl-0 c_LayoutCol18">
											</div>
											<div id="LayoutCol15" class="col col-12 col-sm-2 col-lg-1 c_LayoutCol15">
											</div>
										</div>
									</div>
								</div>
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function COR_TIPO() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		...
		function COR_ENDERECO() { return document.getElementById('RadTextBox5').value; }
