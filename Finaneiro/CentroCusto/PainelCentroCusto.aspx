<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.PainelCentroCusto, App_Web_l2xdquqw" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			<telerik:StyleSheetReference Path="~/Styles/PainelCentroCusto.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/PainelCentroCusto_USER.js?sv=4.0_20240325151732"></script>
											...
											<div id="GRepeaterBody1" runat="server" class="row c_GRepeaterBody1">
												...
												<div id="LayoutCol37" class="col col-12 c_LayoutCol37">
													<div id="LayoutRow12" class="row c_LayoutRow12">
														<div id="LayoutCol32" class="col col-4 c_LayoutCol32">
															<div id="Div10" runat="server" class="c_Div10 card">
																<div class="c_container_PainelCentroCusto_Icon8" id="Icon8Container" runat="server">
																	<i id="Icon8" class="fas fa-comment-dollar c_Icon8">
																	</i>
																</div>
																<telerik:RadLabel id="Label28" runat="server" CssClass="c_Label28" ClientIDMode="Static" Text="<%$ Resources: Label28 %>" />
																<telerik:RadLabel id="Label29" runat="server" CssClass="c_Label29" ClientIDMode="Static" Text="<%$ Resources: Label29 %>" />
															</div>
														</div>
														<div id="LayoutCol33" class="col col-4 c_LayoutCol33">
															<div id="Div11" runat="server" class="c_Div11 card">
																<div class="c_container_PainelCentroCusto_Icon9" id="Icon9Container" runat="server">
																	<i id="Icon9" class="fas fa-hand-holding-usd c_Icon9">
																	</i>
																</div>
																<telerik:RadLabel id="Label30" runat="server" CssClass="c_Label30" ClientIDMode="Static" Text="<%$ Resources: Label30 %>" />
																<telerik:RadLabel id="Label31" runat="server" CssClass="c_Label31" ClientIDMode="Static" Text="<%$ Resources: Label31 %>" />
															</div>
														</div>
														<div id="LayoutCol34" class="col col-4 c_LayoutCol34">
															<div id="Div12" runat="server" class="c_Div12 card">
																<div class="c_container_PainelCentroCusto_Icon10" id="Icon10Container" runat="server">
