<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.LancamentoReceitaCCPage, App_Web_bsrhneeb" culture="auto" uiculture="auto" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<%@ Register Src="..\..\UserControls\Sidebar_Centro_de_Custo.ascx" TagName="uc" TagPrefix="uc" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/LancamentoReceitaCCPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/LancamentoReceitaCCPage_USER.js?sv=4.0_20240312113340"></script>
	...
	<script type="text/javascript">
		...
		function ___CT_ID_OnBlur(sender)
		{
			ValidateCombo(sender);
		}
		...
		function CT_ID_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		...
		<form id="Form1" runat="server" class="c_Form1" SaveFailed="___Form1_OnSaveFailed">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					...
					<telerik:RadTextBox id="TXTMes" runat="server" AutoPostBack="False" CssClass="c_TXTMes textbox-default" EnabledStyle-HorizontalAlign="Left"
						...
						TabIndex="15" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_TXTMes_wrapper" />
								...
								<div id="LayoutRow1" class="row c_LayoutRow1">
									...
									<div id="LayoutCol31" class="col col-12 col-md-4 c_LayoutCol31">
										...
										<telerik:RadComboBox id="GC_ID" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
											...
											OnClientKeyPressing="Combo_HandleKeyPress" OnClientSelectedIndexChanged="ClientRefreshCombos" OnItemsRequested="___GC_ID_OnItemsRequested"
									...
									<div id="LayoutCol4" class="col col-12 col-md-4 c_LayoutCol4">
										...
										<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
											...
											data-validation-engine="validate[funcCall[ComboBox1_Validation]]" data-validation-message="CAT_ID não pode ser vazio!"
											EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
									...
									<div id="LayoutCol7" class="col col-12 col-md-3 c_LayoutCol7">
										...
										<telerik:RadComboBox id="CT_ID" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
											CssClass="c_CT_ID combobox-primary" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
											data-validation-engine="validate[funcCall[CT_ID_Validation]]" data-validation-message="CT_ID não pode ser vazio!"
											EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
											ExpandAnimation-Type="None" ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: CT_ID %>" MarkFirstMatch="true" MaxHeight="300"
											OnClientBlur="___CT_ID_OnBlur" OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
											OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CT_ID_OnItemsRequested" RenderMode="Lightweight" TabIndex="6" />
									...
									<div id="LayoutCol8" class="col col-12 col-md-3 c_LayoutCol8">
										...
										<telerik:RadLabel id="Label34" runat="server" CssClass="c_Label34" IsValidationError="true" Text="<%$ Resources: Label34 %>" />
									</div>
									<div id="LayoutCol10" class="col col-12 col-md-2 c_LayoutCol10">
										...
										<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" CssClass="c_RadTextBox2 textbox-default"
											...
											onkeydown="___RadTextBox2_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="12" TextMode="SingleLine"
											UseTelerikMask="False" WrapperCssClass="c_RadTextBox2_wrapper" />
										<telerik:RadLabel id="Label39" runat="server" CssClass="c_Label39" IsValidationError="true" Text="<%$ Resources: Label39 %>" />
									</div>
									<div id="LayoutCol32" class="col col-12 col-md-2 c_LayoutCol32">
										...
										<telerik:RadDatePicker id="DatePicker2" runat="server" CssClass="c_DatePicker2 datepicker-default"
											...
											EnableEmbeddedSkins="True" Height="32" HideAnimation-Duration="300" HideAnimation-Type="Fade" MinDate="01/01/1900"
											PopupDirection="BottomRight" ReadOnly="False" RenderMode="Lightweight" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="11"
											Width="169" />
										<telerik:RadLabel id="Label23" runat="server" CssClass="c_Label23" IsValidationError="true" Text="<%$ Resources: Label23 %>" />
									</div>
									<div id="LayoutCol9" class="col col-12 col-md-10 c_LayoutCol9">
										...
										<telerik:RadComboBox id="CBCorrentista" runat="server" AllowCustomText="False" AutoPostBack="False"
											...
											OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
											OnItemsRequested="___CBCorrentista_OnItemsRequested" RenderMode="Lightweight" TabIndex="9" />
									...
									<div id="LayoutCol11" class="col col-12 col-md-2 c_LayoutCol11">
										<telerik:RadButton id="Salvar" runat="server" ButtonType="SkinnedButton"
											...
											RenderMode="Lightweight" TabIndex="13" Text="<%$ Resources: Salvar %>">
											<ContentTemplate>
									...
									<div id="LayoutCol13" class="col col-12 c_LayoutCol13">
										<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="True" AllowPaging="True" AllowSorting="True"
											...
											RenderMode="Lightweight" ShowFooter="False" ShowGroupPanel="False" TabIndex="14" TableLayout="Fixed">
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="LANC_ID" EditMode="InPlace">
												<Columns>
													...
													<telerik:GridBoundColumn UniqueName="GridColumn5" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn5" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn5 %>" ItemStyle-CssClass="c_GridColumn5" ItemStyle-Width="86" MaxLength="50" ReadOnly="False"
														ShowFilterIcon="True" ShowSortIcon="True" />
													...
													<telerik:GridButtonColumn UniqueName="GridColumn7" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														...
														HeaderStyle-CssClass="c_GridColumn7" HeaderStyle-Width="93" ItemStyle-CssClass="c_GridColumn7" ItemStyle-Width="86"
														ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn7 %>" />
												</Columns>
