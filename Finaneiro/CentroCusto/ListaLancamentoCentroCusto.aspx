<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaLancamentoCentroCusto, App_Web_l4qwm1wk" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaLancamentoCentroCusto.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/ListaLancamentoCentroCusto_USER.js?sv=4.0_20240403133334"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/CentroCusto/LancamentoCC.aspx?ParamID={ParamID}") %>';
		...
		function ___WindowSettings5_OnClientPageLoad(sender, args)
		{
			OnClientPageLoad(sender);
		}
		function ___WindowSettings5_OnClientShow(sender, args)
		{
			OnClientShow(sender);
		}
		function ___WindowSettings5_OnClientClose(sender, args)
		{
			OnClientClose(sender);
			ShowClientFormulas(true);
		}
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					...
					<telerik:RadWindowManager id="WindowSettings3" runat="server" AutoSize="False" Behaviors="Default" CssClass="c_WindowSettings3"
						...
						ShowContentDuringLoad="False" VisibleOnPageLoad="True" VisibleStatusbar="True" VisibleTitlebar="True" />
					<telerik:RadWindowManager id="WindowSettings5" runat="server" AutoSize="True" Behaviors="Default" CssClass="c_WindowSettings5"
						DestroyOnClose="True" EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False"
						OnClientClose="___WindowSettings5_OnClientClose" OnClientPageLoad="___WindowSettings5_OnClientPageLoad"
						OnClientShow="___WindowSettings5_OnClientShow" PreserveClientState="True" RenderMode="Lightweight" RestrictionZoneID="__MainDiv"
						ShowContentDuringLoad="False" VisibleOnPageLoad="True" VisibleStatusbar="True" VisibleTitlebar="True" />
									...
									<div id="LayoutCol3" class="col col-12 c_LayoutCol3">
										<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="LANC_ID" EditMode="InPlace">
												<Columns>
													<telerik:GridBoundColumn UniqueName="ColunNome" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														ConvertEmptyStringToNull="False" DataField="Nome" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%"
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_ColunNome" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: ColunNome %>" ItemStyle-CssClass="c_ColunNome" ItemStyle-Width="86" MaxLength="255" ReadOnly="False"
													...
													<telerik:GridBoundColumn UniqueName="GridColumn_LANC_DESCRICAO" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														HeaderStyle-CssClass="c_GridColumn_LANC_DESCRICAO" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_LANC_DESCRICAO %>"
														ItemStyle-CssClass="c_GridColumn_LANC_DESCRICAO" ItemStyle-Width="86" MaxLength="100" ReadOnly="False" ShowFilterIcon="True"
														ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn_LANC_TIPO" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_LANC_TIPO"
														HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_LANC_TIPO %>" ItemStyle-CssClass="c_GridColumn_LANC_TIPO"
													...
													<telerik:GridDateTimeColumn UniqueName="GridColumn_LANC_DATA" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														HeaderText="<%$ Resources: GridColumn_LANC_DATA %>" ItemStyle-CssClass="c_GridColumn_LANC_DATA" ItemStyle-Width="86" MaxLength="10"
													...
													<telerik:GridBoundColumn UniqueName="GridColumn_CAT_NOME" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_CAT_NOME %>" ItemStyle-CssClass="c_GridColumn_CAT_NOME"
														ItemStyle-Width="86" MaxLength="100" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn_CT_NOME" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_CT_NOME %>" ItemStyle-CssClass="c_GridColumn_CT_NOME" ItemStyle-Width="86"
													...
													<telerik:GridButtonColumn UniqueName="GridColumn3" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														...
														HeaderStyle-CssClass="c_GridColumn3" HeaderStyle-Width="93" ItemStyle-CssClass="c_GridColumn3" ItemStyle-Width="86"
														ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn3 %>" />
												</Columns>
