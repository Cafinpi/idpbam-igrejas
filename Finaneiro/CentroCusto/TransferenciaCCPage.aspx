<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.TransferenciaCCPage, App_Web_clumysuk" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TransferenciaCCPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../../JS/TransferenciaCCPage_USER.js?sv=4.0_20240318185215"></script>
	...
	<script type="text/javascript">
		...
		function ___CBCOrigem_OnBlur(sender)
		{
			ValidateCombo(sender);
		}
		function ___CBCDestino_OnBlur(sender)
		{
			ValidateCombo(sender);
		}
		function ___SweetAlert1_OnConfirmClick(sender)
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/CentroCusto/TransferenciaCCPage.aspx") %>';
		...
		function CBCOrigem_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function CBCDestino_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow3" class="row c_LayoutRow3">
							<div id="LayoutCol13" class="col col-12 c_LayoutCol13 card">
									...
									<div id="LayoutCol19" class="col col-12 c_LayoutCol19 card-header">
										<div id="Div2" runat="server" class="c_Div2 div-transparent">
											...
											<telerik:RadButton id="Button20" runat="server" ButtonType="SkinnedButton"
												...
												OnClientClicking="___Button20_OnClientClick" RenderMode="Lightweight" TabIndex="2" Text="<%$ Resources: Button20 %>">
												<ContentTemplate>
										...
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol2" class="col col-12 c_LayoutCol2">
												...
												<telerik:RadTextBox id="txtDescricao" runat="server" AutoPostBack="False" CssClass="c_txtDescricao textbox-default"
													data-validation-engine="validate[funcCall[txtDescricao_Validation]]" data-validation-message="TF_DESCRICAO não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="100"
												...
												<telerik:RadLabel id="Label3" runat="server" CssClass="c_Label3" IsValidationError="true" Text="<%$ Resources: Label3 %>" />
											</div>
											<div id="LayoutCol3" class="col col-12 col-sm-6 c_LayoutCol3">
											...
											<div id="LayoutCol15" class="col col-12 col-sm-6 c_LayoutCol15">
												...
												<telerik:RadTextBox id="txtValor" runat="server" AutoPostBack="False" CssClass="c_txtValor textbox-default"
													data-validation-engine="validate[funcCall[txtValor_Validation]]" data-validation-message="TF_VALOR não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="11"
													onkeydown="___txtValor_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="5" TextMode="SingleLine" UseTelerikMask="False"
											...
											<div id="LayoutCol5" class="col col-12 col-sm-6 c_LayoutCol5">
												...
												<telerik:RadComboBox id="CBCOrigem" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_CBCOrigem combobox-default" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[CBCOrigem_Validation]]" data-validation-message="TF_CT_ORIGEM não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#333333" LoadingMessage="<%$ Resources: CBCOrigem %>" MarkFirstMatch="true" MaxHeight="100"
													OnClientBlur="___CBCOrigem_OnBlur" OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBCOrigem_OnItemsRequested" RenderMode="Lightweight" TabIndex="6" />
											...
											<div id="LayoutCol6" class="col col-12 col-sm-6 c_LayoutCol6">
												...
												<telerik:RadComboBox id="CBCDestino" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_CBCDestino combobox-default" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[CBCDestino_Validation]]" data-validation-message="TF_CT_DESTINO não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#333333" LoadingMessage="<%$ Resources: CBCDestino %>" MarkFirstMatch="true" MaxHeight="100"
													OnClientBlur="___CBCDestino_OnBlur" OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBCDestino_OnItemsRequested" RenderMode="Lightweight" TabIndex="7" />
