<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.LancamentoCC, App_Web_bsrhneeb" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/LancamentoCC.css" OrderIndex="1"/>
...
<script type="text/javascript">
	...
	function sweetAlert_SweetAlert3(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       icon:  'success' ,
	       title: customTitle === undefined ? 'Salvo com sucesso!' : customTitle,
		   ...
		   if (result.value) { 
	         ___SweetAlert3_OnConfirmClick(sender)
		   }
		   else if (result.dismiss === Swal.DismissReason.cancel) { 
	         ___SweetAlert3_OnCancelClick(sender)
		   }
	   });
	}
</script>
		<script type="text/javascript" src="../../JS/LancamentoCC_USER.js?sv=4.0_20240312113340"></script>
	...
	<script type="text/javascript">
		...
		function ___CBTipo_OnBlur(sender)
		{
		...
		function ___GC_ID_OnBlur(sender)
		{
			ValidateCombo(sender);
		}
		function ___CBCategoria_OnBlur(sender)
		{
			ValidateCombo(sender);
		}
		function ___CBConta_OnBlur(sender)
		{
			ValidateCombo(sender);
		}
		...
		function ___SweetAlert3_OnConfirmClick(sender)
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/LancamentosPage.aspx?ParamLancamento={ParamLancamento}") %>';
			UrlPage = UrlPage.replace('{ParamLancamento}', '');
			Navigate(UrlPage, false);
		}
		function ___SweetAlert3_OnCancelClick(sender)
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/CentroCusto/ListaLancamentoCentroCusto.aspx") %>';
			Navigate(UrlPage, false);
		}
		function CBTipo_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function DPData_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function GC_ID_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function CBCategoria_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function CBConta_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
								...
								<div id="LayoutRow2" class="row c_LayoutRow2 card flex-row">
									...
									<div id="LayoutCol36" class="col col-12 col-md-2 c_LayoutCol36">
										...
										<telerik:RadTextBox id="TxtAno" runat="server" AutoPostBack="False" CssClass="c_TxtAno textbox-default" EnabledStyle-HorizontalAlign="Left"
											...
											RenderMode="Lightweight" TabIndex="3" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_TxtAno_wrapper" />
									</div>
									<div id="LayoutCol34" class="col col-12 col-md-10 c_LayoutCol34">
										...
										<telerik:RadComboBox id="CBMes" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_CBMes combobox-primary"
											...
											OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBMes_OnItemsRequested" RenderMode="Lightweight" TabIndex="4" />
									</div>
									<div id="LayoutCol20" class="col col-12 c_LayoutCol20 card-body">
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol3" class="col col-12 col-sm-6 col-md-3 c_LayoutCol3">
												...
												<telerik:RadComboBox id="CBTipo" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_CBTipo combobox-primary" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[CBTipo_Validation]]" data-validation-message="LANC_TIPO não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: CBTipo %>" MarkFirstMatch="true" MaxHeight="100"
													OnClientBlur="___CBTipo_OnBlur" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
													OnItemsRequested="___CBTipo_OnItemsRequested" RenderMode="Lightweight" TabIndex="5" />
											...
											<div id="LayoutCol4" class="col col-12 col-sm-6 col-md-4 c_LayoutCol4">
												...
												<telerik:RadTextBox id="txtDescricao" runat="server" AutoPostBack="False" CssClass="c_txtDescricao textbox-default"
													...
													onkeydown="___txtDescricao_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="6" TextMode="SingleLine"
											...
											<div id="LayoutCol5" class="col col-12 col-sm-6 col-md-2 c_LayoutCol5">
												...
												<telerik:RadDatePicker id="DPData" runat="server" Calendar-ClientEvents-OnDateClick="HideDatePickerValidation"
													...
													PopupDirection="TopLeft" ReadOnly="False" RenderMode="Lightweight" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="7"
													Width="169" />
											...
											<div id="LayoutCol9" class="col col-12 col-sm-6 col-md-3 c_LayoutCol9">
												...
												<telerik:RadTextBox id="txtValor" runat="server" AutoPostBack="False" CssClass="c_txtValor textbox-default"
													...
													onkeydown="___txtValor_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="11" TextMode="SingleLine" UseTelerikMask="False"
											...
											<div id="LayoutCol31" class="col col-12 col-md-3 c_LayoutCol31">
												...
												<telerik:RadComboBox id="GC_ID" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_GC_ID combobox-primary" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[GC_ID_Validation]]" data-validation-message="GC_ID não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: GC_ID %>" MarkFirstMatch="true" MaxHeight="300"
													OnClientBlur="___GC_ID_OnBlur" OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
													OnClientKeyPressing="Combo_HandleKeyPress" OnClientSelectedIndexChanged="ClientRefreshCombos"
													OnItemsRequested="___GC_ID_OnItemsRequested" RenderMode="Lightweight" TabIndex="8" />
												<telerik:RadLabel id="Label36" runat="server" CssClass="c_Label36" IsValidationError="true" Text="<%$ Resources: Label36 %>" />
											</div>
											<div id="LayoutCol7" class="col col-12 col-sm-6 col-md-3 c_LayoutCol7">
												<telerik:RadLabel id="Label13" runat="server" CssClass="c_Label13" Text="<%$ Resources: Label13 %>" />
												<telerik:RadComboBox id="CBCategoria" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_CBCategoria combobox-default" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[CBCategoria_Validation]]" data-validation-message="CAT_ID não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#333333" LoadingMessage="<%$ Resources: CBCategoria %>" MarkFirstMatch="true" MaxHeight="300"
													OnClientBlur="___CBCategoria_OnBlur" OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBCategoria_OnItemsRequested" RenderMode="Lightweight" TabIndex="9" />
												<telerik:RadLabel id="Label14" runat="server" CssClass="c_Label14" IsValidationError="true" Text="<%$ Resources: Label14 %>" />
											</div>
											<div id="LayoutCol8" class="col col-12 col-sm-6 col-md-3 c_LayoutCol8">
												<telerik:RadLabel id="Label11" runat="server" CssClass="c_Label11" Text="<%$ Resources: Label11 %>" />
												<telerik:RadComboBox id="CBConta" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													CssClass="c_CBConta combobox-default" CollapseAnimation-Duration="300" CollapseAnimation-Type="None"
													data-validation-engine="validate[funcCall[CBConta_Validation]]" data-validation-message="CT_ID não pode ser vazio!"
													EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300"
													ExpandAnimation-Type="None" ForeColor="#333333" LoadingMessage="<%$ Resources: CBConta %>" MarkFirstMatch="true" MaxHeight="100"
													OnClientBlur="___CBConta_OnBlur" OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___CBConta_OnItemsRequested" RenderMode="Lightweight" TabIndex="10" />
											...
											<div id="LayoutCol27" class="col col-12 c_LayoutCol27">
												...
												<telerik:RadCheckBox id="RadCheckBox2" runat="server" AutoPostBack="True" Checked="False"
													CssClass="RadCheckBox2 c_RadCheckBox2 checkbox-toggle-dark" RenderMode="Lightweight" TabIndex="15" Text="<%$ Resources: RadCheckBox2 %>"
													/>
											</div>
											...
											<div id="LayoutCol22" class="col col-12 col-md-4 c_LayoutCol22">
												...
												<gas:GMultiMedia id="GMultiMedia1" runat="server" AllowFileExtensions="jpg,png,bmp" AmazonAccessKey="AKIA4VJOWCUN4NV5NTVO"
													...
													CanDownloadFile="True" CanUploadFile="True" class="c_GMultiMedia1" EncryptedFile="False" Height="32px" ImageFit="contain" MaxFileSize="0"
													Path="~/Images/Financeiro/" Responsive="true" SaveAsFile="True" SaveOnS3="False" SessionHandlerObjectName="nota_recibo36429"
													ShowDownloadLink="False" ShowImage="False" TabIndex="16" Visible="True" Width="100%" />
											</div>
											<div id="LayoutCol32" class="col col-12 col-md-4 c_LayoutCol32">
												...
												<gas:GMultiMedia id="GMultiMedia2" runat="server" AllowFileExtensions="jpg,png,bmp" AmazonAccessKey="AKIA4VJOWCUN4NV5NTVO"
													AmazonSecretKey="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" BorderWidth="1" BucketFolderPath="financeiro" BucketName="arquivoleao"
													CanDownloadFile="True" CanUploadFile="True" class="c_GMultiMedia2" EncryptedFile="False" Height="32px" ImageFit="contain" MaxFileSize="0"
													Path="~/Images/Financeiro/" Responsive="true" SaveAsFile="True" SaveOnS3="False" SessionHandlerObjectName="anexo236429"
													ShowDownloadLink="False" ShowImage="False" TabIndex="17" Visible="True" Width="100%" />
											</div>
											<div id="LayoutCol33" class="col col-12 col-md-4 c_LayoutCol33">
												...
												<gas:GMultiMedia id="GMultiMedia3" runat="server" AllowFileExtensions="jpg,png,bmp" AmazonAccessKey="AKIA4VJOWCUN4NV5NTVO"
													AmazonSecretKey="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" BorderWidth="1" BucketFolderPath="financeiro" BucketName="arquivoleao"
													CanDownloadFile="True" CanUploadFile="True" class="c_GMultiMedia3" EncryptedFile="False" Height="32px" ImageFit="contain" MaxFileSize="0"
													Path="~/Images/Financeiro/" Responsive="true" SaveAsFile="True" SaveOnS3="False" SessionHandlerObjectName="anexo336429"
													ShowDownloadLink="False" ShowImage="False" TabIndex="18" Visible="True" Width="100%" />
											</div>
					...
					<telerik:RadTextBox id="TXTMes" runat="server" AutoPostBack="False" CssClass="c_TXTMes textbox-default" EnabledStyle-HorizontalAlign="Left"
						...
						TabIndex="19" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_TXTMes_wrapper" />
