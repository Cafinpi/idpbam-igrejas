<%@ page language="C#" validaterequest="false" autoeventwireup="true" inherits="PROJETO.Pages.BlankPage, App_Web_iy4xcs5i" culture="auto" uiculture="auto" %>
		...
		<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
			...
			<script type="text/javascript"> 
				...
				function TryLogin(PageToRedirect, RefreshControlsID)
				{
					...
					TryParentLogin(PageToRedirect, RefreshControlsID, isWindow, '<%= ResolveUrl("~/Login/LoginPage.aspx") %>');
					try 
					{
						if (isWindow) 
						{
