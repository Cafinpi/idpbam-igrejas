<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ContasaReceberPage, App_Web_ye34v321" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ContasaReceberPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../JS/ContasaReceberPage_USER.js?sv=4.0_20240312113337"></script>
	...
	<script type="text/javascript">
		...
		function ___Button19_OnClientClick(sender, args)
		{
			...
			UrlPage = UrlPage.replace('{ParamTipo}', 'Receita');
		...
		function ___ComboBox3_OnClientSelectionChanged()
		{
			ApplyFilter();
		}
		...
		function GridColumn_LANC_DESCRICAO_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function GridColumn_LANC_DATA_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		...
		function GridColumn_pagamento_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					...
					<telerik:RadWindowManager id="WindowSettings3" runat="server" AutoSize="False" Behaviors="Default" CssClass="c_WindowSettings3"
						DestroyOnClose="True" EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False" MaxHeight="130" MaxWidth="500" MinHeight="130"
						MinWidth="500" OnClientClose="___WindowSettings3_OnClientClose" OnClientPageLoad="___WindowSettings3_OnClientPageLoad"
					...
					<telerik:RadWindowManager id="WindowSettings1" runat="server" AutoSize="False" Behaviors="Default" CssClass="c_WindowSettings1"
						DestroyOnClose="True" EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False" MaxHeight="500" MaxWidth="500" MinHeight="500"
						MinWidth="500" OnClientClose="___WindowSettings1_OnClientClose" OnClientPageLoad="___WindowSettings1_OnClientPageLoad"
					...
					<telerik:RadWindowManager id="WindowSettings2" runat="server" AutoSize="False" Behaviors="Default" CssClass="c_WindowSettings2"
						DestroyOnClose="True" EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False" MaxHeight="780" MaxWidth="1210" MinHeight="780"
						MinWidth="1210" OnClientClose="___WindowSettings2_OnClientClose" OnClientPageLoad="___WindowSettings2_OnClientPageLoad"
						...
						<div id="LayoutRow8" class="row c_LayoutRow8">
							...
							<div id="LayoutCol16" class="col col-12 col-sm-6 col-md-4 c_LayoutCol16">
								<telerik:RadComboBox id="ComboBox3" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox3 combobox-default"
									...
									EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None" ForeColor="#333333"
									LoadingMessage="<%$ Resources: ComboBox3_1 %>" MarkFirstMatch="true" MaxHeight="100" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
									OnClientKeyPressing="Combo_HandleKeyPress" OnClientSelectedIndexChanged="___ComboBox3_OnClientSelectionChanged"
									...
									<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="LANC_ID" EditMode="InPlace">
										<Columns>
											...
											<telerik:GridBoundColumn UniqueName="GridColumn_pagamento" runat="server" AllowFiltering="True" AllowSorting="true"
												AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="recebimento" EnableHeaderContextMenu="True" Exportable="True"
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function CBPaga() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
