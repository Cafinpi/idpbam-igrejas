<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.GrupoCategoriaPage, App_Web_0mrdujfn" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/GrupoCategoriaPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/GrupoCategoriaPage_USER.js?sv=4.0_20240318185207"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/ListaDeGruposPage.aspx") %>';
									...
									<div id="LayoutCol19" class="col col-12 c_LayoutCol19 card-header">
										<div id="Div2" runat="server" class="c_Div2 div-transparent">
											...
											<telerik:RadButton id="Button23" runat="server" ButtonType="SkinnedButton" CssClass="c_Button23 button-primary" CommandName="Button23"
												OnClientClicking="___Button23_OnClientClick" RenderMode="Lightweight" TabIndex="5">
												<ContentTemplate>
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function GC_NOME() { return document.getElementById('txtDescricao').value; }
