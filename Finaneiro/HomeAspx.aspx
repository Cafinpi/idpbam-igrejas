<%@ page language="C#" autoeventwireup="true" maintainscrollpositiononpostback="true" enableeventvalidation="True" validaterequest="false" inherits="PROJETO.HomeAspx, App_Web_hpwhwr2d" culture="auto" uiculture="auto" %>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script src='../JS/Mask.js' type="text/javascript"></script>
			...
			<script type="text/javascript" src="../JS/HomeAspx_USER.js?sv=4.0_20240325151724"></script>
