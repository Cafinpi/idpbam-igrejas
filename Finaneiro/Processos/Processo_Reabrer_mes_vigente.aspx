<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.DataPages.Processo_Reabrer_mes_vigente, App_Web_u4jb2g5v" %>
...
<head runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/Processo_Reabrer_mes_vigente.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Processo_Reabrer_mes_vigente_USER.js?sv=4.0_20240325151730"></script>
				...
				<div id="LayoutContainer1" runat="server" class="container c_LayoutContainer1">
					<div id="LayoutRow1" class="row c_LayoutRow1">
						...
						<div id="LayoutCol2" class="col col-6 c_LayoutCol2">
							<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton" CssClass="c_Button1 button-rounded-danger" CommandName="Button1"
