<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.DataPages.Processo_Enviar_Rel_IDPB, App_Web_zt1di403" %>
...
<head runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/Office_2010_Silver_Button_button_danger.css" OrderIndex="0"/>
			<telerik:StyleSheetReference Path="~/Styles/Office_2010_Silver_Button_button_info.css" OrderIndex="0"/>
			<telerik:StyleSheetReference Path="~/Styles/Processo_Enviar_Rel_IDPB.css" OrderIndex="1"/>
	...
	<telerik:RadCodeBlock ID="HeaderCodeBlock" runat="server">
		<link rel="stylesheet" href="../../Styles/loading.css" type="text/css" media="screen" title="no title"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Processo_Enviar_Rel_IDPB_USER.js?sv=4.0_20240309131818"></script>
				...
				<div id="LayoutContainer1" runat="server" class="container c_LayoutContainer1">
					<div id="LayoutRow1" class="row c_LayoutRow1">
						...
						<div id="LayoutCol2" class="col col-6 c_LayoutCol2">
							<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton" CssClass="c_Button1 button-danger" CommandName="Button1"
						...
						<div id="LayoutCol3" class="col col-6 c_LayoutCol3">
							<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton" CssClass="c_Button2 button-info" CommandName="Button2"
					...
					<div id="LayoutRow2" class="row c_LayoutRow2">
						<div id="LayoutCol4" class="col col-12 c_LayoutCol4">
							<telerik:RadAjaxPanel id="AjaxPanel1" runat="server" CssClass="c_AjaxPanel1" LoadingPanelID="___AjaxPanel1_AjaxLoading">
								<telerik:RadAjaxLoadingPanel runat="server" CssClass="c_AjaxLoading1" EnableEmbeddedSkins="False" id="___AjaxPanel1_AjaxLoading">
									<asp:Image id="Image2" runat="server" class="c_Image2" ImageUrl="../../Images/Imagens padrão/loadingprogressbar.gif" />
