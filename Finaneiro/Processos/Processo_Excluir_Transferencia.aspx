<%@ page language="C#" autoeventwireup="true" enableeventvalidation="True" inherits="PROJETO.DataPages.Processo_Excluir_Transferencia, App_Web_j0g0jq1l" %>
...
<head runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/Office_2010_Silver_Button_button_raised_success.css" OrderIndex="0"/>
			<telerik:StyleSheetReference Path="~/Styles/Processo_Excluir_Transferencia.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	...
	<script type="text/javascript" src="../../JS/Processo_Excluir_Transferencia_USER.js?sv=4.0_20240311152743"></script>
				...
				<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
					<div id="LayoutRow1" class="row c_LayoutRow1">
						...
						<div id="LayoutCol3" class="col col-6 c_LayoutCol3">
							<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton" CssClass="c_Button2 button-raised-success" CommandName="Button2"
