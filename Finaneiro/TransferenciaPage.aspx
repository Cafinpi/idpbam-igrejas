<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.TransferenciaPage, App_Web_iy4xcs5i" culture="auto" uiculture="auto" %>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/TransferenciaPage_USER.js?sv=4.0_20240318185206"></script>
