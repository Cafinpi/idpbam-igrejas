<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaLancamentosPage, App_Web_q5jr1k0d" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaLancamentosPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../JS/ListaLancamentosPage_USER.js?sv=4.0_20240309131812"></script>
	...
	<script type="text/javascript">
		...
		function ___WindowSettings4_OnClientPageLoad(sender, args)
		{
			OnClientPageLoad(sender);
		}
		function ___WindowSettings4_OnClientShow(sender, args)
		{
			OnClientShow(sender);
			if (sender.get_navigateUrl() == null) return;
		...
		function ___WindowSettings4_OnClientClose(sender, args)
		{
			OnClientClose(sender);
			ShowClientFormulas(true);
		}
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<telerik:RadWindowManager id="WindowSettings4" runat="server" AutoSize="False" Behaviors="Default" CssClass="c_WindowSettings4"
						DestroyOnClose="True" EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False"
						OnClientClose="___WindowSettings4_OnClientClose" OnClientPageLoad="___WindowSettings4_OnClientPageLoad"
						OnClientShow="___WindowSettings4_OnClientShow" PreserveClientState="True" RenderMode="Lightweight" RestrictionZoneID="__MainDiv"
							...
							<div id="LayoutCol2" class="col col-12 c_LayoutCol2">
								<div id="LayoutRow4" class="row c_LayoutRow4 card flex-row">
									<div id="LayoutCol9" class="col col-12 c_LayoutCol9 card-header">
										<div id="Div1" runat="server" class="c_Div1 div-transparent">
											...
											<telerik:RadButton id="Button18" runat="server" ButtonType="SkinnedButton" CssClass="c_Button18 button-primary" CommandName="Button18"
												OnClientClicking="___Button18_OnClientClick" RenderMode="Lightweight" TabIndex="3">
												<ContentTemplate>
													<span class="gvText"></span>
									...
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="GridListaLancamentos" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="True" AllowPaging="True"
											AllowSorting="True" AutoGenerateColumns="false" CssClass="c_GridListaLancamentos grid-default" CleanLayoutNoRecord="True"
											...
											OnInsertCommand="Grid_InsertCommand" OnItemCommand="GridListaLancamentos_ItemCommand" OnItemCreated="GridListaLancamentos_ItemCreated"
											OnItemDataBound="GridListaLancamentos_ItemDataBound" OnNeedDataSource="Grid_NeedDataSource" OnPreRender="GridListaLancamentos_PreRender"
											OnUpdateCommand="Grid_UpdateCommand" PageSize="10" RenderMode="Lightweight" ShowFooter="False" ShowGroupPanel="False" TabIndex="1"
											TableLayout="Fixed">
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="LANC_ID" EditMode="InPlace" OnPreRender="GridListaLancamentos_PreRender">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														HeaderText="<%$ Resources: GridColumn1 %>" ItemStyle-CssClass="c_GridColumn1" ItemStyle-Width="86" MaxLength="100" ReadOnly="False"
													...
													<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														ConvertEmptyStringToNull="False" DataField="LANC_DESCRICAO" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%"
													...
													<telerik:GridBoundColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														ConvertEmptyStringToNull="False" DataField="LANC_TIPO" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%"
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn4" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn4 %>" ItemStyle-CssClass="c_GridColumn4" ItemStyle-Width="86" MaxLength="100" ReadOnly="False"
														ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn8" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														HeaderText="<%$ Resources: GridColumn8 %>" ItemStyle-CssClass="c_GridColumn8" ItemStyle-Width="86" MaxLength="255" ReadOnly="False"
														ShowFilterIcon="True" ShowSortIcon="True" />
													...
													<telerik:GridButtonColumn UniqueName="GridColumn14" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														CommandName="GridColumn14" EnableHeaderContextMenu="True" Exportable="True" FilterDelay="2000" Groupable="false"
														HeaderStyle-CssClass="c_GridColumn14" HeaderStyle-Width="93" ItemStyle-CssClass="c_GridColumn14" ItemStyle-Width="86"
														ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn14 %>" />
													...
													<telerik:GridButtonColumn UniqueName="GridColumn16" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														CommandName="GridColumn16" EnableHeaderContextMenu="True" Exportable="True" FilterDelay="2000" Groupable="false"
														HeaderStyle-CssClass="c_GridColumn16" HeaderStyle-Width="93" ItemStyle-CssClass="c_GridColumn16" ItemStyle-Width="86"
														ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn16 %>" />
												</Columns>
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#GridListaLancamentos').first().focus();", 200);
				}
			}
			catch (e)
			{
