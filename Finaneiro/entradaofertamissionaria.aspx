<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.entradaofertamissionaria, App_Web_pvpeziro" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/entradaofertamissionaria.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../JS/entradaofertamissionaria_USER.js?sv=4.0_20240309131810"></script>
	...
	<script type="text/javascript">
		...
		function ___RadTextBox_PERC_REPASSE_AM_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		function ___RadTextBox_PERC_REPASSE_NACIONAL_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		...
		function RadTextBox_PERC_REPASSE_AM_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function RadTextBox_PERC_REPASSE_NACIONAL_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
					...
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<telerik:RadLabel id="labModuleTitle" runat="server" CssClass="c_labModuleTitle" Text="Cadastrar entrada oferta missionária" />
								<telerik:RadLabel id="Label1" runat="server" CssClass="c_Label1" Text="<%$ Resources: Label1 %>" />
							</div>
						</div>
						<div id="LayoutRow2" class="row c_LayoutRow2">
							<div id="LayoutCol2" class="col col-12 c_LayoutCol2">
								<telerik:RadLabel id="Label_PERC_REPASSE_AM" runat="server" CssClass="c_Label_PERC_REPASSE_AM" Text="<%$ Resources: Label_PERC_REPASSE_AM %>"
									/>
								<telerik:RadTextBox id="RadTextBox_PERC_REPASSE_AM" runat="server" AutoPostBack="False"
									CssClass="c_RadTextBox_PERC_REPASSE_AM textbox-default" data-validation-engine="validate[funcCall[RadTextBox_PERC_REPASSE_AM_Validation]]"
									data-validation-message="PERC_REPASSE_AM não pode ser vazio!" EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True"
									ForeColor="#333333" MaxLength="11" onkeydown="___RadTextBox_PERC_REPASSE_AM_onkeydown();" ReadOnly="False" RenderMode="Lightweight"
									TabIndex="1" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_RadTextBox_PERC_REPASSE_AM_wrapper" />
							</div>
							<div id="LayoutCol3" class="col col-12 c_LayoutCol3">
								<telerik:RadLabel id="Label_PERC_REPASSE_NACIONAL" runat="server" CssClass="c_Label_PERC_REPASSE_NACIONAL"
									Text="<%$ Resources: Label_PERC_REPASSE_NACIONAL %>" />
								<telerik:RadTextBox id="RadTextBox_PERC_REPASSE_NACIONAL" runat="server" AutoPostBack="False"
									CssClass="c_RadTextBox_PERC_REPASSE_NACIONAL textbox-default"
									data-validation-engine="validate[funcCall[RadTextBox_PERC_REPASSE_NACIONAL_Validation]]"
									data-validation-message="PERC_REPASSE_NACIONAL não pode ser vazio!" EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True"
									ForeColor="#333333" MaxLength="11" onkeydown="___RadTextBox_PERC_REPASSE_NACIONAL_onkeydown();" ReadOnly="False" RenderMode="Lightweight"
									TabIndex="2" TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_RadTextBox_PERC_REPASSE_NACIONAL_wrapper" />
							</div>
						</div>
						<div id="LayoutRow3" class="row c_LayoutRow3">
							<div id="LayoutCol4" class="col col-12 col-md-2 offset-0 offset-sm-0 offset-md-10 offset-lg-10 offset-xl-10 c_LayoutCol4">
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#RadTextBox_PERC_REPASSE_AM').first().focus();", 200);
				}
			}
			catch (e)
			{
		...
		function PERC_REPASSE_AM() { return document.getElementById('RadTextBox_PERC_REPASSE_AM').value; }
		function PERC_REPASSE_NACIONAL() { return document.getElementById('RadTextBox_PERC_REPASSE_NACIONAL').value; }
		...
		function LoadEditAuto() {
				$j("#RadTextBox_PERC_REPASSE_AM").bind("keydown", InitiateEditAuto);
				$j("#RadTextBox_PERC_REPASSE_NACIONAL").bind("keydown", InitiateEditAuto);
		}
