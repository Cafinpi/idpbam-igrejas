<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.LanContasPagRecPage, App_Web_q5jr1k0d" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/LanContasPagRecPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/LanContasPagRecPage_USER.js?sv=4.0_20240309131819"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Finaneiro/LanContasPagRecPage.aspx?ParamIdLanc={ParamIdLanc}") %>';
							...
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<div id="Div2" runat="server" class="c_Div2 div-transparent">
									...
									<telerik:RadButton id="Button24" runat="server" ButtonType="SkinnedButton"
										CssClass="c_Button24 button-raised-secondary gvButtonIconText gvButtonAlignIconLeft" CommandName="Button24" OnClick="___Button24_OnClick"
										RenderMode="Lightweight" TabIndex="11" Text="<%$ Resources: Button24 %>">
										<ContentTemplate>
						...
						<div id="LayoutRow2" class="row c_LayoutRow2">
							...
							<div id="LayoutCol3" class="col col-12 col-md-2 c_LayoutCol3">
								...
								<telerik:RadDatePicker id="DatePicker1" runat="server" Calendar-ClientEvents-OnDateClick="HideDatePickerValidation"
									...
									PopupDirection="BottomRight" ReadOnly="False" RenderMode="Lightweight" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="3"
									Width="176" />
							</div>
							<div id="LayoutCol4" class="col col-12 col-md-3 c_LayoutCol4">
								...
								<telerik:RadComboBox id="ComboBox1" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox1 combobox-primary"
									...
									LoadingMessage="<%$ Resources: ComboBox1 %>" MarkFirstMatch="true" MaxHeight="300" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
							...
							<div id="LayoutCol5" class="col col-12 col-md-3 c_LayoutCol5">
								...
								<telerik:RadComboBox id="ComboBox2" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: ComboBox2 %>" MarkFirstMatch="true" MaxHeight="300" OnClientBlur="___ComboBox2_OnBlur"
							...
							<div id="LayoutCol6" class="col col-12 col-md-4 c_LayoutCol6">
								...
								<telerik:RadComboBox id="ComboBox5" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[ComboBox5_Validation]]" data-validation-message="GC_ID não pode ser vazio!"
									EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None"
									ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: ComboBox5 %>" MarkFirstMatch="true" MaxHeight="300" OnClientBlur="___ComboBox5_OnBlur"
									OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
							...
							<div id="LayoutCol7" class="col col-12 col-md-4 c_LayoutCol7">
								...
								<telerik:RadComboBox id="ComboBox4" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[ComboBox4_Validation]]" data-validation-message="CAT_ID não pode ser vazio!"
									EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None"
									ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: ComboBox4 %>" MarkFirstMatch="true" MaxHeight="300" OnClientBlur="___ComboBox4_OnBlur"
									OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
							...
							<div id="LayoutCol8" class="col col-12 col-md-4 c_LayoutCol8">
								...
								<telerik:RadComboBox id="ComboBox3" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None"
									ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: ComboBox3 %>" MarkFirstMatch="true" MaxHeight="300" OnClientBlur="___ComboBox3_OnBlur"
									OnClientItemsRequested="CheckComboItems" OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
							...
							<div id="LayoutCol10" class="col col-12 col-md-3 c_LayoutCol10">
								...
								<telerik:RadTextBox id="RadTextBox3" runat="server" AutoPostBack="False" CssClass="c_RadTextBox3 textbox-default"
									data-validation-engine="validate[funcCall[RadTextBox3_Validation]]" data-validation-message="LANC_VALOR não pode ser vazio!"
							...
							<div id="LayoutCol11" class="col col-12 col-md-6 c_LayoutCol11">
								...
								<telerik:RadComboBox id="CBCorrentista" runat="server" AllowCustomText="False" AutoPostBack="False"
									CssClass="c_CBCorrentista combobox-primary" CollapseAnimation-Duration="300" CollapseAnimation-Type="None" EnableEmbeddedSkins="True"
								...
								<telerik:RadComboBox id="ComboBox7" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox7 combobox-danger"
									CollapseAnimation-Duration="300" CollapseAnimation-Type="None" EnableEmbeddedSkins="True" EnableLoadOnDemand="True"
									EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None" ForeColor="#DC3545"
									LoadingMessage="<%$ Resources: ComboBox7 %>" MarkFirstMatch="true" MaxHeight="300" OnClientItemsRequested="CheckComboItems"
									OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
									OnItemsRequested="___ComboBox7_OnItemsRequested" RenderMode="Lightweight" TabIndex="14" />
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function LANC_TIPO() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function CC_ID() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function GC_ID() { return $find("<%= ComboBox5.ClientID %>").get_value(); }
		function CAT_ID() { return $find("<%= ComboBox4.ClientID %>").get_value(); }
		function CT_ID() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
		function TxrQtdParcela() { return document.getElementById('RadTextBox2').value; }
		function LANC_VALOR() { return document.getElementById('RadTextBox3').value; }
		function COR_ID() { return $find("<%= CBCorrentista.ClientID %>").get_value(); }
		function id_membro() { return $find("<%= ComboBox7.ClientID %>").get_value(); }
