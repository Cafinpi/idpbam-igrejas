<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.AlterarSenhaFinanceiroPage, App_Web_au5qv2il" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/AlterarSenhaFinanceiroPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/AlterarSenhaFinanceiroPage_USER.js?sv=4.0_20240318185221"></script>
					...
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<telerik:RadLabel id="Label4" runat="server" CssClass="c_Label4" />
							...
							<div id="LayoutCol2" class="col col-12 c_LayoutCol2">
								...
								<telerik:RadTextBox id="txtNewPasswordConfirm" runat="server" AutoPostBack="False" CssClass="c_txtNewPasswordConfirm textbox-default"
									data-validation-engine="validate[funcCall[txtNewPasswordConfirm_Validation]]" data-validation-message="O valor não pode ser vazio"
									EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0"
									onkeydown="___txtNewPasswordConfirm_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="2" TextMode="Password"
									UseTelerikMask="False" WrapperCssClass="c_txtNewPasswordConfirm_wrapper" />
