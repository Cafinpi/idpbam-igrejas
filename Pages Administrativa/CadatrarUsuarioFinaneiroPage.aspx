<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.CadatrarUsuarioFinaneiroPage, App_Web_rhk5yajc" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/CadatrarUsuarioFinaneiroPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/CadatrarUsuarioFinaneiroPage_USER.js?sv=4.0_20240403133338"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							...
							<div id="LayoutCol3" class="col col-12 col-md-7 c_LayoutCol3">
							...
							<div id="LayoutCol4" class="col col-12 col-md-5 c_LayoutCol4">
							...
							<div id="LayoutCol6" class="col col-12 c_LayoutCol6">
								...
								<telerik:RadTextBox id="RadTextBox3" runat="server" AutoPostBack="False" CssClass="c_RadTextBox3 textbox-default"
									data-validation-engine="validate[funcCall[RadTextBox3_Validation]]" data-validation-message="Observações não pode ser vazio!"
									EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="60"
									onkeydown="___RadTextBox3_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="6" TextMode="MultiLine" UseTelerikMask="False"
								...
								<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
									...
									<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="LOGIN_USER_LOGIN" EditMode="InPlace">
										<Columns>
											...
											<telerik:GridBoundColumn UniqueName="GridColumn_LOGIN_USER_OBS" runat="server" AllowFiltering="True" AllowSorting="true"
												AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="LOGIN_USER_OBS" EnableHeaderContextMenu="True" Exportable="True"
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_LOGIN_USER_OBS"
												HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_LOGIN_USER_OBS %>" ItemStyle-CssClass="c_GridColumn_LOGIN_USER_OBS"
												ItemStyle-Width="86" MaxLength="0" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function LOGIN_USER_OBS() { return document.getElementById('RadTextBox3').value; }
