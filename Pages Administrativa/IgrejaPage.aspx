<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.IgrejaPage, App_Web_cesfuuei" culture="auto" uiculture="auto" %>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/IgrejaPage_USER.js?sv=4.0_20240312113346"></script>
