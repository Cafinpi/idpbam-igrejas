<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.AlterarSenhaADMPage, App_Web_rhk5yajc" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/AlterarSenhaADMPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/AlterarSenhaADMPage_USER.js?sv=4.0_20240403133339"></script>
	...
	<script type="text/javascript">
		...
		function ___LOGIN_USER_PASSWORD_OnTextBoxButtonClick(sender, args)
		{
					...
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								...
								<telerik:RadTextBox id="LOGIN_USER_PASSWORD" runat="server" AutoPostBack="False" ButtonsPosition="Right"
									CssClass="c_LOGIN_USER_PASSWORD textbox-default" ClientEvents-OnButtonClick="___LOGIN_USER_PASSWORD_OnTextBoxButtonClick"
									...
									onkeydown="___LOGIN_USER_PASSWORD_onkeydown();" ReadOnly="False" RenderMode="Lightweight" ShowButton="True" TabIndex="1" TextMode="Password"
