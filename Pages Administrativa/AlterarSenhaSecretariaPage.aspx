<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.AlterarSenhaSecretariaPage, App_Web_rfdtxyl4" culture="auto" uiculture="auto" %>
...
<script type="text/javascript">
	...
	function sweetAlert_SweetAlert2(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../JS/AlterarSenhaSecretariaPage_USER.js?sv=4.0_20240309131829"></script>
