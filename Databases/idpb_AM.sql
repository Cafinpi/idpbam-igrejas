...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('CONS_REL_FECHAMENTO_IGREJAS') AND sysstat & 0xf = 2)
DROP VIEW [CONS_REL_FECHAMENTO_IGREJAS]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('CONS_SALDORECEBER_IGREJALOCAL') AND sysstat & 0xf = 2)
DROP VIEW [CONS_SALDORECEBER_IGREJALOCAL]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('VV_DADOS_RECIBO') AND sysstat & 0xf = 2)
DROP VIEW [VV_DADOS_RECIBO]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('VV_NUMERO_RECIBO') AND sysstat & 0xf = 2)
DROP VIEW [VV_NUMERO_RECIBO]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('CATEGORIA_IDPB') AND sysstat & 0xf = 3)
DROP TABLE [CATEGORIA_IDPB]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('CONTAS_IDPB') AND sysstat & 0xf = 3)
DROP TABLE [CONTAS_IDPB]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('GRUPO_CATEGORIA_IDPB') AND sysstat & 0xf = 3)
DROP TABLE [GRUPO_CATEGORIA_IDPB]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('SUB_CONTAS_IDPB') AND sysstat & 0xf = 3)
DROP TABLE [SUB_CONTAS_IDPB]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('TB_LANCAMENTO_IGREJAS') AND sysstat & 0xf = 3)
DROP TABLE [TB_LANCAMENTO_IGREJAS]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('TB_MES_EXTENSO') AND sysstat & 0xf = 3)
DROP TABLE [TB_MES_EXTENSO]
GO
...
IF EXISTS (SELECT * FROM sysobjects WHERE id = object_id('TB_RECIBO') AND sysstat & 0xf = 3)
DROP TABLE [TB_RECIBO]
GO
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [CONTAS_IDPB](
	[COD_CONTAS]                           varchar (10)         NOT NULL,
	[DESC_CONTAS]                          varchar (500)        NOT NULL,
	[COD_CATEGORIA]                        varchar (10)         NOT NULL
)
GO
...
/*------------------------------------------------------------*/
/*    Criação de Tabelas, Indices e Atribuição de Default    */
/*          GRUPO_CATEGORIA_IDPB          */
/*------------------------------------------------------------*/

 CREATE TABLE [GRUPO_CATEGORIA_IDPB](
	[COD_CATEGORIA]                        varchar (10)         NOT NULL,
	[COD_GRUPO_CAT_IDPB]                   varchar (10)         NOT NULL,
	[DESC_GRUPO_IDPB]                      varchar (500)        NOT NULL
)
GO
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [SUB_CONTAS_IDPB](
	[COD_SUB_CONTA]                        varchar (10)         NOT NULL,
	[DESC_SUB_CONTA]                       varchar (500)        NOT NULL,
	[COD_PLANO_CONTA]                      bigint               DEFAULT 0 NOT NULL,
	[COD_CATEGORIA]                        varchar (10)         NOT NULL,
	[DESC_CATEGORIA]                       varchar (500)        NOT NULL,
	[COD_GRUPO_CAT_IDPB]                   varchar (10)         NOT NULL,
	[DESC_GRUPO_IDPB]                      varchar (500)        NOT NULL,
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [TB_LANCAMENTO](
	...
	[codigo_igreja]                        varchar (50)         NULL,
	[recibo]                               bit                  DEFAULT 0 NOT NULL,
	[recebidoIgrejaLocal]                  bit                  NULL
...
/*------------------------------------------------------------*/
/*    Criação de Tabelas, Indices e Atribuição de Default    */
/*          TB_LANCAMENTO_IGREJAS          */
/*------------------------------------------------------------*/

 CREATE TABLE [TB_LANCAMENTO_IGREJAS](
	[LANC_ID]                              bigint               DEFAULT 0 NOT NULL,
	[LANC_DESCRICAO]                       varchar (100)        NULL,
	[LANC_DATA]                            date                 NOT NULL,
	[LANC_TIPO]                            varchar (100)        NOT NULL,
	[LANC_VALOR]                           decimal (10,2)       DEFAULT 0 NOT NULL,
	[LANC_PAGO]                            bit                  NOT NULL,
	[LANC_DATA_HORA_INCLUSAO]              datetime             NULL,
	[COR_ID]                               bigint               DEFAULT 0 NULL,
	[CAT_ID]                               bigint               DEFAULT 0 NOT NULL,
	[CT_ID]                                bigint               DEFAULT 0 NOT NULL,
	...
	[anexo3]                               varchar (500)        NULL,
	[idLancamentoMissao]                   bigint               DEFAULT 0 NULL,
	[codigo_igreja]                        varchar (50)         NOT NULL
		CONSTRAINT [PK_TB_LANCAMENTO1] PRIMARY KEY CLUSTERED
		(
			[LANC_ID]
		) WITH FILLFACTOR = 90
)
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [TB_MES_EXTENSO](
	[Mes]                                  bigint               DEFAULT 0 NOT NULL,
	[Extenso]                              varchar (100)        NOT NULL
		CONSTRAINT [PK_TB_MES_EXTENSO] PRIMARY KEY CLUSTERED
		(
			[Mes]
		) WITH FILLFACTOR = 90
)
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [TB_MESES_FECHAMENTO_IGREJA](
	...
	[VALORECEBIDO]                         decimal (10,2)       DEFAULT 0 NOT NULL,
	[TotalRecebido]                        decimal (10,2)       DEFAULT 0 NULL,
	[totalareceber]                        decimal (10,2)       DEFAULT 0 NULL
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [TB_PARAMETRO](
	...
	[PAR_PERC_IDPB_NACIONAL]               decimal (10,3)       DEFAULT 0 NOT NULL,
	[CC_SAIDA_CONTRIBUICAOMM]              bigint               DEFAULT 0 NOT NULL,
	[PAR_CENTROCUSTO]                      bigint               DEFAULT 0 NOT NULL,
	[PERC_REPASSE_AM]                      decimal (10,3)       DEFAULT 0 NOT NULL,
	[PERC_REPASSE_NACIONAL]                decimal (10,3)       DEFAULT 0 NOT NULL,
	[CAT_MISSOES_AM]                       bigint               DEFAULT 0 NOT NULL,
	[CAT_MISSOES_NACIONAL]                 bigint               DEFAULT 0 NOT NULL,
	[PAR_PERC_IDPB_AM]                     decimal (10,3)       DEFAULT 0 NOT NULL
...
/*------------------------------------------------------------*/
 ...
 CREATE TABLE [TB_RECIBO](
	...
	[Data]                                 datetime             NOT NULL,
	[recebedorIgreja]                      varchar (255)        NULL,
	[DOCIgreja]                            varchar (255)        NULL,
	[recebedorOutros]                      varchar (255)        NULL,
	[DOCOutros]                            varchar (255)        NULL,
	[LANC_ID]                              bigint               DEFAULT 0 NOT NULL
		CONSTRAINT [PK_TB_RECIBO] PRIMARY KEY CLUSTERED
		(
			[Numero]
		) WITH FILLFACTOR = 90
)
GO
 ...
 CREATE UNIQUE INDEX [NK_TB_RECIBO1] ON [TB_RECIBO]
	([LANC_ID])
GO
...
select [CONS_VALOR_MES_ANO].[Mes], [CONS_VALOR_MES_ANO].[ano], Sum([CONS_VALOR_MES_ANO].[LANC_VALOR]) as acumuladoMes
 from [CONS_VALOR_MES_ANO]
 
group by [CONS_VALOR_MES_ANO].[Mes], [CONS_VALOR_MES_ANO].[ano]
)
GO
...
Select CONS_LANCAMENTOS_GRUPOS_CATEGORIA.CC_ID, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_VALOR, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.CAT_NOME, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.CAT_ID, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.COR_NOME, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.COR_ID, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.CT_NOME, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_DATA_HORA_INCLUSAO, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.CT_ID, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.PAGO, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_TIPO, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_DESCRICAO, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_DATA, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_ID, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.GC_NOME, CONS_LANCAMENTOS_GRUPOS_CATEGORIA.GC_ID, CONS_ACUMULADO_MES_ANO.acumuladoMes From CONS_LANCAMENTOS_GRUPOS_CATEGORIA, CONS_ACUMULADO_MES_ANO Where CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_TIPO <> 'Transferência' And Month(CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_DATA) = CONS_ACUMULADO_MES_ANO.Mes And Year(CONS_LANCAMENTOS_GRUPOS_CATEGORIA.LANC_DATA) = CONS_ACUMULADO_MES_ANO.ano
)
GO
...
Select VV_CENSOGERAL.TotalCrianca, VV_CENSOGERAL.TotalMembros, VV_CENSOGERAL.TotalAdolescente, VV_CENSOGERAL.TotalJovem, VV_CENSOGERAL.TotalAdulto, VV_CENSOGERAL.TotalIdoso, VV_CENSOGERAL.Situacao, VV_CENSOGERAL.Distrito, VV_CENSOGERAL.Coordenacao, VV_CENSOGERAL.Supervisao, VV_CENSOGERAL.Celula, VV_DISTRITO.Distrito_Nome, VV_DISTRITO.Coordenacao_Nome, VV_DISTRITO.Supervisao_Nome, VV_DISTRITO.Nome
From VV_CENSOGERAL Left Join VV_DISTRITO On VV_CENSOGERAL.Distrito = VV_DISTRITO.Distrito And VV_CENSOGERAL.Coordenacao = VV_DISTRITO.Coordenacao And VV_CENSOGERAL.Supervisao = VV_DISTRITO.Supervisao And VV_CENSOGERAL.Celula = VV_DISTRITO.Celula
)
GO
...
Select VV_RELATORIOCELEBRACAO.id, VV_RELATORIOCELEBRACAO.Celula, VV_RELATORIOCELEBRACAO.Distrito, VV_RELATORIOCELEBRACAO.Semana, 
VV_RELATORIOCELEBRACAO.Data, VV_RELATORIOCELEBRACAO.Adultos, VV_RELATORIOCELEBRACAO.Criancas, VV_RELATORIOCELEBRACAO.Visitantes, 
VV_RELATORIOCELEBRACAO.Conversoes, VV_RELATORIOCELEBRACAO.Observacoes, 
VV_RELATORIOCELEBRACAO.RolMembros, VV_RELATORIOCELEBRACAO.NomeMembros, VV_RELATORIOCELEBRACAO.PresencaMembros, membros.Coordenacao, 
membros.Supervisao, membros.Nascimento, VV_RELATORIOCELEBRACAO.mesRelatorio,
Case When Floor(DateDiff(DAY, membros.Nascimento, GetDate()) / 365.25) <= 12 Then 'Criança' Else 'Adulto' End As tipoMembro, distrito.Distrito_Nome, 
cordenacao.Coordenacao_Nome, supervisao.Supervisao_Nome, celulas.Nome 
From VV_RELATORIOCELEBRACAO Left Join membros On VV_RELATORIOCELEBRACAO.RolMembros = membros.RolMembro Left Join distrito On 
membros.Distrito = distrito.Distrito Left Join cordenacao On membros.Coordenacao = cordenacao.
Coordenacao Left Join supervisao On membros.Supervisao = supervisao.Supervisao Left Join celulas On membros.Celula = celulas.Celula
)
GO
...
SELECT  [id]
 ...
 PresencaMembros BIT N'$.Presenca'
  ...
  WHERE [Data] BETWEEN DATEADD(MONTH,-3, DATEADD(m, DATEDIFF(m, 0, GETDATE()), 0))  AND DATEADD(m, DATEDIFF(m, 0, GETDATE()), -1
)
GO
...
Select Distinct VV_RELATORIOCELULA.id,
  VV_RELATORIOCELULA.Celula,
  VV_RELATORIOCELULA.Distrito,
  VV_RELATORIOCELULA.Semana,
  VV_RELATORIOCELULA.Data,
  VV_RELATORIOCELULA.Adultos,
  VV_RELATORIOCELULA.Criancas,
  VV_RELATORIOCELULA.Visitantes,
  VV_RELATORIOCELULA.PresentesEventos,
  VV_RELATORIOCELULA.Visitas,
  VV_RELATORIOCELULA.Conversoes,
  VV_RELATORIOCELULA.Observacoes,
  VV_RELATORIOCELULA.RolMembros,
  VV_RELATORIOCELULA.NomeMembros,
  VV_RELATORIOCELULA.PresencaMembros,
  membros.Coordenacao,
  membros.Supervisao,
  membros.Nascimento,
  Case
    When Floor(DateDiff(DAY, membros.Nascimento, GetDate()) / 365.25) <= 12 Then
      'Criança'
    Else 'Adulto'
  End As tipoMembro,
  distrito.Distrito_Nome,
  cordenacao.Coordenacao_Nome,
  supervisao.Supervisao_Nome,
  celulas.Nome
From VV_RELATORIOCELULA
  Left Join membros On VV_RELATORIOCELULA.RolMembros = membros.RolMembro
  Left Join distrito On membros.Distrito = distrito.Distrito
  Left Join cordenacao On membros.Coordenacao = cordenacao.Coordenacao
      And membros.Distrito = cordenacao.Distrito
  Left Join supervisao On membros.Supervisao = supervisao.Supervisao And
      membros.Distrito = supervisao.Distrito And membros.Coordenacao =
      supervisao.Coordenacao
  Left Join celulas On membros.Celula = celulas.Celula And membros.Distrito =
      celulas.Distrito And membros.Coordenacao = celulas.Coordenacao And
...
Select Top 1000
  ...
  Sum(Case When CONS_LANCAMENTO_COMPLETOS.LANC_TIPO = 'Receita' Then LANC_VALOR End) As Receita, 
  Sum(Case When CONS_LANCAMENTO_COMPLETOS.LANC_TIPO = 'Despesa' Then LANC_VALOR * -1 End) As Despesa,
  (Sum(Case When CONS_LANCAMENTO_COMPLETOS.LANC_TIPO = 'Receita' Then LANC_VALOR End) - Sum(Case When CONS_LANCAMENTO_COMPLETOS.LANC_TIPO = 'Despesa' Then LANC_VALOR * -1 End)) as Saldo,
  TB_CENTRO_CUSTO.CC_NOME
From CONS_LANCAMENTO_COMPLETOS
  Left Join TB_CENTRO_CUSTO On CONS_LANCAMENTO_COMPLETOS.CC_ID =
...
Select TB_LANCAMENTO.LANC_ID,
  ...
  End As LANC_VALOR,
  idpb_AM.dbo.fncNumeroPorExtenso(TB_LANCAMENTO.LANC_VALOR, 1) As VALOR_EXTENSO,
  ...
  TB_CONTA.CT_NOME,
  TB_CORRENTISTA.COR_NOME,
  TB_CORRENTISTA.COR_TIPO_DOC,
  TB_CORRENTISTA.COR_NUM_DOC,
  TB_CORRENTISTA.COR_NASCIMENTO,
  TB_CORRENTISTA.COR_ENDERECO,
  TB_CORRENTISTA.COR_BAIRRO,
  TB_CORRENTISTA.COR_CIDADE,
  TB_CORRENTISTA.COR_EMAIL,
  TB_CORRENTISTA.COR_TIPO,
  TB_CORRENTISTA.COR_TELEFONE,
  igreja.nome As igreja,
  igreja.cnpj,
  TB_LANCAMENTO.codigo_igreja,
  a.Nome As NomeIgreja,
  a.NomeJurisdicao,
  a.NomeDistrito,
  a.PastorPresidente,
  a.CPFPastorPresidente,
  a.cnpj as CNPJIgrejaLocal
From TB_LANCAMENTO
  Left Join bd_idpb.dbo.igrejasIdpb As a On TB_LANCAMENTO.codigo_igreja =
      a.Codigo
  Left Join TB_CONTA On TB_LANCAMENTO.CT_ID = TB_CONTA.CT_ID
  Left Join TB_CORRENTISTA On TB_LANCAMENTO.COR_ID = TB_CORRENTISTA.COR_ID,
  igreja
Where TB_LANCAMENTO.LANC_TIPO <> 'Transferência' And TB_LANCAMENTO.LANC_PAGO = 1
)
GO
...
Select inscritosEventosGeral.id, inscritosEventosGeral.idEvento, inscritosEventosGeral.Evento, inscritosEventosGeral.Identificador, inscritosEventosGeral.Nascimento, inscritosEventosGeral.Email, inscritosEventosGeral.Contato, inscritosEventosGeral.Igreja, inscritosEventosGeral.Status, inscritosEventosGeral.RolMembro, inscritosEventosGeral.CreatedAt, inscritosEventosGeral.Distrito, inscritosEventosGeral.participante, inscritosEventosGeral.Documento, inscritosEventosGeral.valor_pago, inscritosEventosGeral.forma_pagamento, inscritosEventosGeral.data_pagamento, VV_MEMBROS.idade, VV_MEMBROS.CelulaNome, VV_MEMBROS.Supervisao_Nome, VV_MEMBROS.Supervisao, VV_MEMBROS.Coordenacao_Nome, VV_MEMBROS.Coordenacao, VV_MEMBROS.Distrito_Nome, VV_MEMBROS.Situacao, VV_MEMBROS.Sexo, VV_MEMBROS.Celula, inscritosEventosGeral.Nome, VV_MEMBROS.Nascimento As NascimentoMembro From inscritosEventosGeral Left Join VV_MEMBROS On VV_MEMBROS.RolMembro = inscritosEventosGeral.RolMembro
)
GO
...
/*------------------------------------------------------------*/
 ...
 CREATE VIEW [VV_NUMERO_RECIBO]AS(
SELECT 
case when Numero is null then 0 else MAX(Numero) end as Numero FROM TB_RECIBO group by Numero
)
GO
...
/*------------------------------------------------------------*/
/*                      Criação de VIEW                      */
/*             CONS_REL_FECHAMENTO_IGREJAS             */
/*------------------------------------------------------------*/

 CREATE VIEW [CONS_REL_FECHAMENTO_IGREJAS]AS(
Select a.CC_ID,
  a.LANC_VALOR,
  Sum(b.LANC_VALOR) As valorAcumulado,
  a.CAT_NOME,
  a.CAT_ID,
  a.COR_ID,
  a.LANC_DATA_HORA_INCLUSAO,
  a.CT_ID,
  a.LANC_TIPO,
  a.LANC_DESCRICAO,
  a.LANC_DATA,
  ...
  TB_GRUPO_CATEGORIA.GC_NOME,
  Case
    When a.LANC_TIPO = 'Receita' Then a.LANC_VALOR
  End As Receita,
  Case
    When a.LANC_TIPO = 'Despesa' Then a.LANC_VALOR * -1
  End As Despesa
From TB_LANCAMENTO_IGREJAS As a
  Left Join TB_LANCAMENTO_IGREJAS As b On a.LANC_DATA >= b.LANC_DATA
      And a.LANC_ID >= b.LANC_ID And a.anoReferencia = b.anoReferencia And
      a.mesReferencia = b.mesReferencia
 Left Join TB_GRUPO_CATEGORIA On a.GC_ID = TB_GRUPO_CATEGORIA.GC_ID
...
/*------------------------------------------------------------*/
/*                      Criação de VIEW                      */
/*              CONS_SALDORECEBER_IGREJALOCAL              */
/*------------------------------------------------------------*/

 CREATE VIEW [CONS_SALDORECEBER_IGREJALOCAL]AS(
select [TB_REL_FECHAMENTO].[mesReferencia], [TB_REL_FECHAMENTO].[anoReferencia], [TB_REL_FECHAMENTO].[codigoIgreja], Sum([TB_REL_FECHAMENTO].[VALORARECEBER]) as TotalARecer, Sum([TB_REL_FECHAMENTO].[VALORECEBIDO]) as TotalRecebido
 from [TB_REL_FECHAMENTO]
 
group by [TB_REL_FECHAMENTO].[mesReferencia], [TB_REL_FECHAMENTO].[anoReferencia], [TB_REL_FECHAMENTO].[codigoIgreja]
)
GO
...
/*------------------------------------------------------------*/
 ...
 CREATE VIEW [VV_DADOS_RECIBO]AS(
Select CONS_LANCAMENTO_COMPLETOS.LANC_ID, CONS_LANCAMENTO_COMPLETOS.LANC_DESCRICAO, CONS_LANCAMENTO_COMPLETOS.LANC_TIPO, CONS_LANCAMENTO_COMPLETOS.LANC_DATA, CONS_LANCAMENTO_COMPLETOS.LANC_VALOR, CONS_LANCAMENTO_COMPLETOS.COR_ID, CONS_LANCAMENTO_COMPLETOS.CAT_ID, CONS_LANCAMENTO_COMPLETOS.CAT_NOME, CONS_LANCAMENTO_COMPLETOS.VALOR_EXTENSO, CONS_LANCAMENTO_COMPLETOS.COR_NOME, CONS_LANCAMENTO_COMPLETOS.COR_NUM_DOC, CONS_LANCAMENTO_COMPLETOS.COR_ENDERECO, CONS_LANCAMENTO_COMPLETOS.COR_BAIRRO, CONS_LANCAMENTO_COMPLETOS.COR_CIDADE, CONS_LANCAMENTO_COMPLETOS.COR_TELEFONE, CONS_LANCAMENTO_COMPLETOS.Igreja, CONS_LANCAMENTO_COMPLETOS.cnpj, CONS_LANCAMENTO_COMPLETOS.NomeIgreja, CONS_LANCAMENTO_COMPLETOS.nomeJurisdicao, CONS_LANCAMENTO_COMPLETOS.nomeDistrito, CONS_LANCAMENTO_COMPLETOS.PastorPresidente, CONS_LANCAMENTO_COMPLETOS.CPFPastorPresidente, CONS_LANCAMENTO_COMPLETOS.CNPJIgrejaLocal, TB_RECIBO.Numero From CONS_LANCAMENTO_COMPLETOS Left Join TB_RECIBO On CONS_LANCAMENTO_COMPLETOS.LANC_ID = TB_RECIBO.LANC_ID
)
GO
