...
From TB_LANCAMENTO
 ...
 inner Join idpb_RR.dbo.TB_CATEGORIA On TB_CATEGORIA.CAT_ID = TB_LANCAMENTO.CAT_ID And TB_CATEGORIA.GC_ID = TB_LANCAMENTO.GC_ID
Union All
...
From TB_TRANSFERENCIA
  Left Join idpb_RR.dbo.TB_CATEGORIA On TB_CATEGORIA.CAT_ID =
...
Select TB_GRUPO_CATEGORIA.GC_NOME, Sum(TB_LANCAMENTO.LANC_VALOR) As TOTAL, TB_LANCAMENTO.mesReferencia, TB_LANCAMENTO.anoReferencia From TB_LANCAMENTO Inner Join idpb_AM.dbo.TB_CATEGORIA On TB_CATEGORIA.CAT_ID = TB_LANCAMENTO.CAT_ID Inner Join idpb_RR.dbo.TB_GRUPO_CATEGORIA On TB_GRUPO_CATEGORIA.GC_ID = TB_CATEGORIA.GC_ID Group By TB_GRUPO_CATEGORIA.GC_NOME, TB_LANCAMENTO.mesReferencia, TB_LANCAMENTO.anoReferencia
)
GO
...
Select TB_GRUPO_CATEGORIA.GC_ID,
  ...
  TB_CATEGORIA.CAT_ID,
  TB_CATEGORIA.CAT_NOME
From [idpb_RR].[dbo].TB_GRUPO_CATEGORIA
  Left Join [idpb_RR].[dbo].TB_CATEGORIA On TB_GRUPO_CATEGORIA.GC_ID = TB_CATEGORIA.GC_ID
)
GO
...
select [TB_CATEGORIA].[CAT_ID], [TB_CATEGORIA].[CAT_NOME], [TB_CATEGORIA].[GC_ID], [GC_CATEGORIA].[GC_NOME]
 from [idpb_RR].[dbo].[TB_CATEGORIA]
 left join [idpb_RR].[dbo].[TB_GRUPO_CATEGORIA] as [GC_CATEGORIA] on [TB_CATEGORIA].[GC_ID] = [GC_CATEGORIA].[GC_ID]
)
GO
...
Select TB_TRANSFERENCIA.TF_ID, TB_TRANSFERENCIA.TF_DESCRICAO, TB_TRANSFERENCIA.TF_DATA, TB_TRANSFERENCIA.TF_CT_ORIGEM, TB_CONTA.CT_NOME As FANCONTAORIGEM, TB_TRANSFERENCIA.TF_CT_DESTINO, CONTADESTINO.CT_NOME As FANCONTADESTINO, TB_TRANSFERENCIA.TF_VALOR, TB_TRANSFERENCIA.CAT_ID, TB_CATEGORIA.CAT_NOME, TB_TRANSFERENCIA.TF_DATA_HORA_INCLUSAO, TB_TRANSFERENCIA.mesReferencia, TB_TRANSFERENCIA.anoReferencia, TB_TRANSFERENCIA.TF_CC_ORIGEM, TB_TRANSFERENCIA.TF_CC_DESTINO From TB_TRANSFERENCIA Left Join idpb_RR.dbo.TB_CATEGORIA On TB_CATEGORIA.CAT_ID = TB_TRANSFERENCIA.CAT_ID And TB_CATEGORIA.GC_ID = TB_TRANSFERENCIA.GC_ID Left Join TB_CONTA On TB_CONTA.CT_ID = TB_TRANSFERENCIA.TF_CT_ORIGEM Left Join TB_CONTA As CONTADESTINO On CONTADESTINO.CT_ID = TB_TRANSFERENCIA.TF_CT_DESTINO
)
GO
...
From CONS_UNION_CAT_MES
  ...
  Left Join idpb_RR.dbo.TB_GRUPO_CATEGORIA On CONS_UNION_CAT_MES.GC_ID =
