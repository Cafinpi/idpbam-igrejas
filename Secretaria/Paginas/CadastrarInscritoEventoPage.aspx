<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.CadastrarInscritoEventoPage, App_Web_5m1112mp" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/CadastrarInscritoEventoPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/CadastrarInscritoEventoPage_USER.js?sv=4.0_20240309131843"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					...
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							...
							<div id="LayoutCol2" class="col col-2 offset-0 offset-sm-0 offset-md-0 offset-lg-0 offset-xl-4 c_LayoutCol2">
							...
							<div id="LayoutCol4" class="col col-12 c_LayoutCol4">
								<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
									...
									<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="idEvento,RolMembro,Documento" EditMode="InPlace">
										<Columns>
											<telerik:GridBoundColumn UniqueName="GridColumn_Evento" runat="server" AllowFiltering="True" AllowSorting="true"
												AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="Evento" EnableHeaderContextMenu="True" Exportable="True"
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_Evento" HeaderStyle-Width="93"
												HeaderText="<%$ Resources: GridColumn_Evento %>" ItemStyle-CssClass="c_GridColumn_Evento" ItemStyle-Width="86" MaxLength="0"
												ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
											<telerik:GridBoundColumn UniqueName="GridColumn_Identificador" runat="server" AllowFiltering="True" AllowSorting="true"
												AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="Identificador" EnableHeaderContextMenu="True" Exportable="True"
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_Identificador"
												HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_Identificador %>" ItemStyle-CssClass="c_GridColumn_Identificador"
												ItemStyle-Width="86" MaxLength="45" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
											...
											<telerik:GridBoundColumn UniqueName="GridColumn_Contato" runat="server" AllowFiltering="True" AllowSorting="true"
												...
												ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
											<telerik:GridBoundColumn UniqueName="GridColumn_Status" runat="server" AllowFiltering="True" AllowSorting="true"
												AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="Status" EnableHeaderContextMenu="True" Exportable="True"
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_Status" HeaderStyle-Width="93"
												HeaderText="<%$ Resources: GridColumn_Status %>" ItemStyle-CssClass="c_GridColumn_Status" ItemStyle-Width="86" MaxLength="50"
												ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
											<telerik:GridBoundColumn UniqueName="GridColumn_Distrito" runat="server" AllowFiltering="True" AllowSorting="true"
												...
												ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_Distrito" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="93"
												HeaderText="<%$ Resources: GridColumn_Distrito %>" ItemStyle-CssClass="c_GridColumn_Distrito" ItemStyle-HorizontalAlign="Right"
												ItemStyle-Width="86" MaxLength="11" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
											<telerik:GridBoundColumn UniqueName="GridColumn_participante" runat="server" AllowFiltering="True" AllowSorting="true"
												AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="participante" EnableHeaderContextMenu="True" Exportable="True"
												FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_participante"
												HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn_participante %>" ItemStyle-CssClass="c_GridColumn_participante"
												ItemStyle-Width="86" MaxLength="50" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
