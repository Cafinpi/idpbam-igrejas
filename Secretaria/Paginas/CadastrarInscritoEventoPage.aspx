<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.CadastrarInscritoEventoPage, App_Web_eneh40ea" culture="auto" uiculture="auto" %>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/CadastrarInscritoEventoPage_USER.js?sv=4.0_20240311152802"></script>
