<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListadeCursosPage, App_Web_agsujsqw" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListadeCursosPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../../JS/ListadeCursosPage_USER.js?sv=4.0_20240309131844"></script>
								...
								<div id="LayoutRow2" class="row c_LayoutRow2 card flex-row">
									...
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="codigoCurso" EditMode="InPlace">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn_codigoCurso" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="codigoCurso" DataFormatString="{0:#########0}"
														EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%" FilterDelay="2000" FooterStyle-HorizontalAlign="Right"
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_codigoCurso" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="85"
														HeaderText="<%$ Resources: GridColumn_codigoCurso %>" ItemStyle-CssClass="c_GridColumn_codigoCurso" ItemStyle-HorizontalAlign="Right"
														ItemStyle-Width="78" MaxLength="10" ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn_Curso" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														FilterControlWidth="100%" FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_Curso" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn_Curso %>" ItemStyle-CssClass="c_GridColumn_Curso" ItemStyle-Width="86" MaxLength="255"
														ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridCheckBoxColumn UniqueName="GridColumn_PreRequisito" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="PreRequisito" EnableHeaderContextMenu="True" Exportable="True"
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_PreRequisito" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn_PreRequisito %>" ItemStyle-CssClass="c_GridColumn_PreRequisito" ItemStyle-Width="86"
														ReadOnly="False" ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn_Requisito" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="Requisito" DataFormatString="{0:#########0}"
														EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="100%" FilterDelay="2000" FooterStyle-HorizontalAlign="Right"
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn_Requisito" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn_Requisito %>" ItemStyle-CssClass="c_GridColumn_Requisito" ItemStyle-HorizontalAlign="Right"
