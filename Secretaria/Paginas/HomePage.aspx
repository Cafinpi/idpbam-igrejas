<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.HomePage, App_Web_uonbfczu" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/HomePage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/HomePage_USER.js?sv=4.0_20240318185239"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="containerDefault container-fluid c_LayoutContainer1">
						<div id="LayoutRow2" class="row c_LayoutRow2">
							<div id="LayoutCol16" class="col col-12 c_LayoutCol16">
								<div id="LayoutRow1" class="row c_LayoutRow1">
									...
									<div id="LayoutCol2" class="col col-12 col-md-2 c_LayoutCol2">
										...
										<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton" CssClass="c_Button1 button-secondary" CommandName="Button1"
									...
									<div id="LayoutCol3" class="col col-12 col-md-2 c_LayoutCol3">
										...
										<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton" CssClass="c_Button2 button-secondary" CommandName="Button2"
									...
									<div id="LayoutCol4" class="col col-12 col-md-2 c_LayoutCol4">
										...
										<telerik:RadButton id="Button3" runat="server" ButtonType="SkinnedButton" CssClass="c_Button3 button-secondary" CommandName="Button3"
									...
									<div id="LayoutCol5" class="col col-12 col-md-2 c_LayoutCol5">
										...
										<telerik:RadButton id="Button4" runat="server" ButtonType="SkinnedButton" CssClass="c_Button4 button-secondary" CommandName="Button4"
									...
									<div id="LayoutCol6" class="col col-12 col-md-2 c_LayoutCol6">
										...
										<telerik:RadButton id="Button5" runat="server" ButtonType="SkinnedButton" CssClass="c_Button5 button-secondary" CommandName="Button5"
									...
									<div id="LayoutCol7" class="col col-12 col-md-2 c_LayoutCol7">
										...
										<telerik:RadButton id="Button6" runat="server" ButtonType="SkinnedButton" CssClass="c_Button6 button-secondary" CommandName="Button6"
									...
									<div id="LayoutCol8" class="col col-12 col-md-1 offset-0 offset-sm-0 offset-md-2 offset-lg-2 offset-xl-0 c_LayoutCol8">
										<telerik:RadLabel id="Label8" runat="server" CssClass="c_Label8" Text="<%$ Resources: Label8 %>" />
										<telerik:RadLabel id="Label9" runat="server" CssClass="c_Label9" />
									</div>
									<div id="LayoutCol9" class="col col-12 col-md-1 c_LayoutCol9">
										<telerik:RadLabel id="Label10" runat="server" CssClass="c_Label10" Text="<%$ Resources: Label10 %>" />
										<telerik:RadLabel id="Label11" runat="server" CssClass="c_Label11" />
									</div>
									<div id="LayoutCol10" class="col col-12 col-md-2 c_LayoutCol10">
										...
										<telerik:RadLabel id="Label13" runat="server" CssClass="c_Label13" />
									</div>
									<div id="LayoutCol11" class="col col-12 col-md-2 c_LayoutCol11">
										...
										<telerik:RadLabel id="Label15" runat="server" CssClass="c_Label15" />
									</div>
									<div id="LayoutCol12" class="col col-12 col-md-2 c_LayoutCol12">
										<telerik:RadLabel id="Label16" runat="server" CssClass="c_Label16" Text="<%$ Resources: Label16 %>" />
										<telerik:RadLabel id="Label17" runat="server" CssClass="c_Label17" />
									</div>
									<div id="LayoutCol13" class="col col-12 col-md-1 c_LayoutCol13">
										<telerik:RadLabel id="Label26" runat="server" CssClass="c_Label26" Text="<%$ Resources: Label26 %>" />
										<telerik:RadLabel id="Label25" runat="server" CssClass="c_Label25" />
									</div>
									<div id="LayoutCol14" class="col col-12 col-md-1 c_LayoutCol14">
										<telerik:RadLabel id="Label28" runat="server" CssClass="c_Label28" Text="<%$ Resources: Label28 %>" />
										<telerik:RadLabel id="Label27" runat="server" CssClass="c_Label27" />
									</div>
									<div id="LayoutCol15" class="col col-12 col-md-2 c_LayoutCol15">
										<telerik:RadLabel id="Label29" runat="server" CssClass="c_Label29" />
									</div>
								</div>
							</div>
							...
							<div id="LayoutCol19" class="col col-12 col-md-6 c_LayoutCol19">
							...
							<div id="LayoutCol20" class="col col-3 c_LayoutCol20">
							</div>
