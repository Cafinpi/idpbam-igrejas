<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.PagamentoTurmaPage, App_Web_dvjgew55" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/PagamentoTurmaPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/PagamentoTurmaPage_USER.js?sv=4.0_20240403133351"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							...
							<div id="LayoutCol22" class="col col-12 col-md-2 offset-0 offset-sm-0 offset-md-4 offset-lg-4 offset-xl-4 c_LayoutCol22">
							...
							<div id="LayoutCol30" class="col col-12 col-md-2 c_LayoutCol30">
						...
						<div id="LayoutRow2" class="row c_LayoutRow2">
							...
							<div id="LayoutCol26" class="col col-12 col-md-4 c_LayoutCol26">
								...
								<telerik:RadTextBox id="RadTextBox_valor_pago" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_valor_pago textbox-default"
									...
									onkeydown="___RadTextBox_valor_pago_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="4" TextMode="SingleLine"
									UseTelerikMask="False" WrapperCssClass="c_RadTextBox_valor_pago_wrapper" />
							</div>
							<div id="LayoutCol27" class="col col-12 col-md-4 c_LayoutCol27">
