<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.NucleosPage, App_Web_if5qibfo" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/NucleosPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	...
	function sweetAlert_SweetAlert2(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       text: customMessage === undefined ? 'Númeração do núcleo já cadastrada!' : customMessage,
	       showCloseButton:  false,
		...
		<script type="text/javascript" src="../../JS/NucleosPage_USER.js?sv=4.0_20240403133350"></script>
							...
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<div id="Div1" runat="server" class="c_Div1 div-transparent">
									...
									<telerik:RadButton id="Button27" runat="server" ButtonType="SkinnedButton"
										...
										OnClientClicking="___Button27_OnClientClick" RenderMode="Lightweight" TabIndex="4" Text="<%$ Resources: Button27 %>">
										<ContentTemplate>
							...
							<div id="LayoutCol2" class="col col-12 c_LayoutCol2">
								<div id="LayoutRow3" class="row c_LayoutRow3">
									<div id="LayoutCol3" class="col col-2 c_LayoutCol3">
										<telerik:RadLabel id="Label1" runat="server" CssClass="c_Label1" enabled="false" Text="<%$ Resources: Label1 %>" />
									...
									<div id="LayoutCol4" class="col col-10 c_LayoutCol4">
										...
										<telerik:RadTextBox id="RadTextBox2" runat="server" AutoPostBack="False" CssClass="c_RadTextBox2 textbox-default"
											data-validation-engine="validate[funcCall[RadTextBox2_Validation]]" data-validation-message="nomeNucleo não pode ser vazio!"
											EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="255"
											onkeydown="___RadTextBox2_onkeydown();" OnTextChanged="___RadTextBox2_TextChanged" ReadOnly="False" RenderMode="Lightweight" TabIndex="2"
											TextMode="SingleLine" UseTelerikMask="False" WrapperCssClass="c_RadTextBox2_wrapper" />
									</div>
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="Funcao,RolMembro,Celula,Distrito,Coordenacao,Supervisao" EditMode="InPlace">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														ConvertEmptyStringToNull="False" DataField="Nome" EnableHeaderContextMenu="False" Exportable="True" FilterControlWidth="100%"
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function idNucleo() { return document.getElementById('RadTextBox1').value; }
		function nomeNucleo() { return document.getElementById('RadTextBox2').value; }
		function Endereco() { return document.getElementById('RadTextBox3').value; }
