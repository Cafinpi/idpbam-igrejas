<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaCelulaPage, App_Web_y1x2aqha" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaCelulaPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/ListaCelulaPage_USER.js?sv=4.0_20240311152759"></script>
    ...
    <script type="text/javascript">
		...
		function GetAditionalFields(senderName) 
		{
			...
			switch (senderName) 
			{
				...
				case "CBSupervisao":
					...
					{
						"CBDistrito" : jQuery("#CBDistrito")[0].control.get_value(),
						"CBCoordenacao" : jQuery("#CBCoordenacao")[0].control.get_value(),
					};
					break;
			}
		...
		function ClientRefreshCombos(sender, args) 
		{
			...
			{
				case "CBDistrito":
					PrepareAndRequestItems(new Array("CBCoordenacao", "CBSupervisao"));
					break;
				case "CBCoordenacao":
					PrepareAndRequestItems(new Array("CBSupervisao"));
					break;
			}
		}
	</script>
	<script type="text/javascript">
		...
		function ___CBCelula_OnClientSelectionChanged()
		{
			Refresh(this);
		}
		...
		<form id="Form1" runat="server" class="c_Form1">
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					...
					<telerik:RadWindowManager id="WindowSettings1" runat="server" AutoSize="False" Behaviors="Default" CssClass="c_WindowSettings1"
						DestroyOnClose="True" EnableFocusNextWindowShortcut="True" EnableShadow="True" HasScroll="False" MaxHeight="120" MaxWidth="500"
								...
								<div id="LayoutRow3" class="row c_LayoutRow3 card flex-row">
									...
									<div id="LayoutCol12" class="col col-3 c_LayoutCol12">
										...
										<telerik:RadComboBox id="CBCoordenacao" runat="server" AllowCustomText="False" AutoPostBack="False"
											...
											OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
											OnClientSelectedIndexChanged="ClientRefreshCombos" OnItemsRequested="___CBCoordenacao_OnItemsRequested" RenderMode="Lightweight"
											TabIndex="6" />
									</div>
									<div id="LayoutCol13" class="col col-3 c_LayoutCol13">
										...
										<telerik:RadComboBox id="CBSupervisao" runat="server" AllowCustomText="False" AutoPostBack="False"
											...
											OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
											OnItemsRequested="___CBSupervisao_OnItemsRequested" RenderMode="Lightweight" TabIndex="7" />
									</div>
									<div id="LayoutCol14" class="col col-3 c_LayoutCol14">
										...
										<telerik:RadComboBox id="CBCelula" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_CBCelula combobox-primary"
											CollapseAnimation-Duration="300" CollapseAnimation-Type="None" EnableEmbeddedSkins="True" EnableLoadOnDemand="True"
											EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None" ForeColor="#A4ABB2"
											LoadingMessage="<%$ Resources: CBCelula %>" MarkFirstMatch="true" MaxHeight="300" OnClientItemsRequested="CheckComboItems"
											OnClientItemsRequesting="Combo_OnClientItemsRequesting" OnClientKeyPressing="Combo_HandleKeyPress"
											OnClientSelectedIndexChanged="___CBCelula_OnClientSelectionChanged" OnItemsRequested="___CBCelula_OnItemsRequested"
											RenderMode="Lightweight" TabIndex="8" />
									</div>
									<div id="LayoutCol10" class="col col-12 c_LayoutCol10 card-body">
										<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True" AllowSorting="True"
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="Distrito,Coordenacao,Supervisao,Celula" EditMode="InPlace">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn7" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn7" HeaderStyle-Width="143"
														HeaderText="<%$ Resources: GridColumn7 %>" ItemStyle-CssClass="c_GridColumn7" ItemStyle-Width="136" MaxLength="200" ReadOnly="False"
													...
													<telerik:GridBoundColumn UniqueName="GridColumn8" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn8" HeaderStyle-Width="143"
														HeaderText="<%$ Resources: GridColumn8 %>" ItemStyle-CssClass="c_GridColumn8" ItemStyle-Width="136" MaxLength="150" ReadOnly="False"
														ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn3" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn3" HeaderStyle-Width="143"
														HeaderText="<%$ Resources: GridColumn3 %>" ItemStyle-CssClass="c_GridColumn3" ItemStyle-Width="136" MaxLength="100" ReadOnly="False"
														ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn1" HeaderStyle-Width="143"
														HeaderText="<%$ Resources: GridColumn1 %>" ItemStyle-CssClass="c_GridColumn1" ItemStyle-Width="136" MaxLength="255" ReadOnly="False"
														ShowFilterIcon="True" ShowSortIcon="True" />
													<telerik:GridButtonColumn UniqueName="GridColumn9" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														...
														ItemStyle-CssClass="c_GridColumn9" ItemStyle-Width="86" ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn9_1 %>"
														/>
													...
													<telerik:GridButtonColumn UniqueName="GridColumn11" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														...
														HeaderStyle-CssClass="c_GridColumn11" HeaderStyle-Width="93" ItemStyle-CssClass="c_GridColumn11" ItemStyle-Width="86"
														ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn11 %>" />
												</Columns>
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function __CBCelula() { return $find("<%= CBCelula.ClientID %>").get_value(); }
