<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.InscritosTurmaMembroPage, App_Web_if5qibfo" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/InscritosTurmaMembroPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       text: customMessage === undefined ? 'Membro já cadastrado para o curso!' : customMessage,
		...
		<script type="text/javascript" src="../../JS/InscritosTurmaMembroPage_USER.js?sv=4.0_20240403133349"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow4" class="row c_LayoutRow4">
							...
							<div id="LayoutCol18" class="col col-12 col-md-6 col-lg-2 offset-0 offset-sm-0 offset-md-0 offset-lg-4 offset-xl-4 c_LayoutCol18">
								<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton"
									CssClass="c_Button1 button-primary gvButtonIconText gvButtonAlignIconLeft" CommandName="Button1" RenderMode="Lightweight" TabIndex="7"
							...
							<div id="LayoutCol3" class="col col-12 col-md-6 col-lg-2 c_LayoutCol3">
								<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton"
									...
									RenderMode="Lightweight" TabIndex="8" Text="<%$ Resources: Button2 %>">
									<ContentTemplate>
						...
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<div id="Div2" runat="server" class="c_Div2 div-transparent">
									...
									<telerik:RadButton id="Button23" runat="server" ButtonType="SkinnedButton"
										...
										RenderMode="Lightweight" TabIndex="2" Text="<%$ Resources: Button23 %>">
										<ContentTemplate>
							...
							<div id="LayoutCol12" class="col col-12 col-md-4 c_LayoutCol12">
								...
								<telerik:RadComboBox id="CBRolMembro" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[CBRolMembro_Validation]]" data-validation-message="RolMembro não pode ser vazio!"
									EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None"
							...
							<div id="LayoutCol26" class="col col-12 col-md-4 c_LayoutCol26">
								...
								<telerik:RadTextBox id="RadTextBox_valor_pago" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_valor_pago textbox-default"
									...
									onkeydown="___RadTextBox_valor_pago_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="10" TextMode="SingleLine"
							...
							<div id="LayoutCol28" class="col col-12 col-md-4 c_LayoutCol28">
								...
								<telerik:RadComboBox id="ComboBox2" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox2 combobox-primary"
									...
									OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox2_OnItemsRequested" RenderMode="Lightweight" TabIndex="11" />
							</div>
