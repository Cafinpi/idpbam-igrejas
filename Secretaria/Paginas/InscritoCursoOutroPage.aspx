<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.InscritoCursoOutroPage, App_Web_if5qibfo" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/InscritoCursoOutroPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/InscritoCursoOutroPage_USER.js?sv=4.0_20240403133351"></script>
	...
	<script type="text/javascript">
		...
		function ___RadTextBoxNome_onkeydown(event,vgWin)
		{
			onTextChanged(event);
		}
		function ___RadTextBoxDocumento_onkeydown(event,vgWin)
		{
		}
		...
		function RadTextBoxNome_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
		function RadTextBoxDocumento_Validation(field, rules, i, options) {
			if (!(validateCall(field, "required", options))) {
				return field.attr('data-validation-message');
			}
		}
						...
						<div id="LayoutRow4" class="row c_LayoutRow4">
							...
							<div id="LayoutCol3" class="col col-12 col-md-6 col-lg-2 c_LayoutCol3">
								<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton"
									CssClass="c_Button2 button-primary gvButtonIconText gvButtonAlignIconLeft" CommandName="Button2" RenderMode="Lightweight" TabIndex="2"
						...
						<div id="LayoutRow1" class="row c_LayoutRow1">
							<div id="LayoutCol1" class="col col-12 c_LayoutCol1">
								<div id="Div2" runat="server" class="c_Div2 div-transparent">
									...
									<telerik:RadButton id="Button21" runat="server" ButtonType="SkinnedButton"
										...
										RenderMode="Lightweight" TabIndex="3" Text="<%$ Resources: Button21 %>">
										<ContentTemplate>
									...
									<telerik:RadButton id="Button23" runat="server" ButtonType="SkinnedButton"
										...
										OnClientClicking="___Button23_OnClientClick" RenderMode="Lightweight" TabIndex="4" Text="<%$ Resources: Button23 %>">
										<ContentTemplate>
							...
							<div id="LayoutCol2" class="col col-12 col-md-3 c_LayoutCol2">
								...
								<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[ComboBox1_Validation]]" data-validation-message="idTurma não pode ser vazio!" enabled="false"
							...
							<div id="LayoutCol7" class="col col-12 col-md-4 c_LayoutCol7">
								...
								<telerik:RadTextBox id="RadTextBoxNome" runat="server" AutoPostBack="False" CssClass="c_RadTextBoxNome textbox-default"
									data-validation-engine="validate[funcCall[RadTextBoxNome_Validation]]" data-validation-message="Nome não pode ser vazio!"
									EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="255"
									onkeydown="___RadTextBoxNome_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="11" TextMode="SingleLine"
									UseTelerikMask="False" WrapperCssClass="c_RadTextBoxNome_wrapper" />
								<telerik:RadLabel id="Label13" runat="server" CssClass="c_Label13" IsValidationError="true" Text="<%$ Resources: Label13 %>" />
							</div>
							<div id="LayoutCol32" class="col col-2 c_LayoutCol32">
								...
								<telerik:RadDatePicker id="DatePicker1" runat="server" CssClass="c_DatePicker1 datepicker-default"
									...
									ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="15" Width="176" />
							</div>
							<div id="LayoutCol8" class="col col-12 col-md-3 c_LayoutCol8">
								...
								<telerik:RadComboBox id="ComboBox3" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox3 combobox-primary"
									...
									OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox3_OnItemsRequested" RenderMode="Lightweight" TabIndex="6" />
							</div>
							<div id="LayoutCol31" class="col col-4 c_LayoutCol31">
								...
								<telerik:RadTextBox id="RadTextBoxDocumento" runat="server" AutoPostBack="False" CssClass="c_RadTextBoxDocumento textbox-default"
									data-validation-engine="validate[funcCall[RadTextBoxDocumento_Validation]]" data-validation-message="Documento não pode ser vazio!"
									EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="50"
									onkeydown="___RadTextBoxDocumento_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="14" TextMode="SingleLine"
									UseTelerikMask="False" WrapperCssClass="c_RadTextBoxDocumento_wrapper" />
								<telerik:RadLabel id="Label35" runat="server" CssClass="c_Label35" IsValidationError="true" Text="<%$ Resources: Label35 %>" />
							</div>
							<div id="LayoutCol19" class="col col-4 c_LayoutCol19">
							...
							<div id="LayoutCol30" class="col col-4 c_LayoutCol30">
								...
								<telerik:RadTextBox id="RadTextBox3" runat="server" AutoPostBack="False" CssClass="c_RadTextBox3 textbox-default"
									...
									onkeydown="___RadTextBox3_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="13" TextMode="SingleLine" UseTelerikMask="False"
									WrapperCssClass="c_RadTextBox3_wrapper" />
							</div>
							<div id="LayoutCol25" class="col col-12 col-md-4 c_LayoutCol25">
								...
								<telerik:RadDatePicker id="DatePicker_data_pagamento" runat="server" CssClass="c_DatePicker_data_pagamento datepicker-default"
									...
									PopupDirection="BottomRight" ReadOnly="False" RenderMode="Lightweight" ShowAnimation-Duration="300" ShowAnimation-Type="Fade" TabIndex="7"
									Width="374" />
							</div>
							<div id="LayoutCol26" class="col col-12 col-md-4 c_LayoutCol26">
								...
								<telerik:RadTextBox id="RadTextBox_valor_pago" runat="server" AutoPostBack="False" CssClass="c_RadTextBox_valor_pago textbox-default"
									...
									onkeydown="___RadTextBox_valor_pago_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="8" TextMode="SingleLine"
									UseTelerikMask="False" WrapperCssClass="c_RadTextBox_valor_pago_wrapper" />
							</div>
							<div id="LayoutCol28" class="col col-12 col-md-4 c_LayoutCol28">
								...
								<telerik:RadComboBox id="ComboBox2" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox2 combobox-primary"
									CollapseAnimation-Duration="300" CollapseAnimation-Type="None" EnableEmbeddedSkins="True" EnableLoadOnDemand="True"
									EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None" ForeColor="#A4ABB2"
									LoadingMessage="<%$ Resources: ComboBox2 %>" MarkFirstMatch="true" MaxHeight="300" OnClientItemsRequesting="Combo_OnClientItemsRequesting"
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function idTurma() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function Nome() { return document.getElementById('RadTextBoxNome').value; }
		...
		function Documento() { return document.getElementById('RadTextBoxDocumento').value; }
		function Email() { return document.getElementById('RadTextBox2').value; }
		function Contato() { return document.getElementById('RadTextBox3').value; }
		...
		function LoadEditAuto() {
				$j("#RadTextBoxNome").bind("keydown", InitiateEditAuto);
				$j("#RadTextBoxDocumento").bind("keydown", InitiateEditAuto);
