<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaMembrosPage, App_Web_y1x2aqha" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaMembrosPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/ListaMembrosPage_USER.js?sv=4.0_20240311152759"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Secretaria/Paginas/SelecionaCelulaPage.aspx") %>';
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="RolMembro" EditMode="InPlace">
												<Columns>
													...
													<telerik:GridDateTimeColumn UniqueName="GridColumn4" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														ItemStyle-CssClass="c_GridColumn4" ItemStyle-Width="86" MaxLength="10" PickerType="DatePicker" ReadOnly="False" ShowFilterIcon="True"
														ShowSortIcon="True" />
													...
													<telerik:GridButtonColumn UniqueName="GridColumn8" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														...
														HeaderStyle-CssClass="c_GridColumn8" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn8 %>"
														ItemStyle-CssClass="c_GridColumn8" ItemStyle-Width="86" ShowFilterIcon="True" ShowSortIcon="True" Text="<%$ Resources: GridColumn8_1 %>"
														/>
