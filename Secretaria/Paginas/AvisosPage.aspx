<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.AvisosPage, App_Web_1rsa1f0q" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/AvisosPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
		...
		<script type="text/javascript" src="../../JS/AvisosPage_USER.js?sv=4.0_20240312113357"></script>
								...
								<div id="LayoutRow2" class="row c_LayoutRow2 card flex-row">
									...
									<div id="LayoutCol20" class="col col-12 c_LayoutCol20 card-body">
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol221" class="col col-6 c_LayoutCol221">
												...
												<telerik:RadComboBox id="CBDistrito" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_CBDistrito combobox-primary"
													...
													OnItemsRequested="___CBDistrito_OnItemsRequested" RenderMode="Lightweight" TabIndex="4" />
											...
											<div id="LayoutCol2" class="col col-2 c_LayoutCol2">
												...
												<telerik:RadDateTimePicker id="DatePicker1" runat="server" CssClass="c_DatePicker1 datepicker-default"
													...
													TabIndex="1" TimeView-EndTime="23:00" TimeView-StartTime="00:00" Width="134" />
											</div>
											<div id="LayoutCol21" class="col col-12 c_LayoutCol21">
												...
												<gas:GEditor id="GEditor1" runat="server" CssClass="c_GEditor1" EnableEmbeddedSkins="True" TabIndex="2" ViewMode="Design" />
											</div>
