<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.SupervisaoPage, App_Web_eneh40ea" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/SupervisaoPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert2(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       text: customMessage === undefined ? 'Supervisão já casdastrada para essa coordenação e distrito.' : customMessage,
	...
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       showConfirmButton:true,
	       confirmButtonText:'Nova Supervisão' ,
		...
		<script type="text/javascript" src="../../JS/SupervisaoPage_USER.js?sv=4.0_20240311152759"></script>
	...
	<script type="text/javascript">
		...
		function ___txtSupervisao_onkeydown(event,vgWin)
		{
		}
		function ___txtNomeSupervisao_onkeydown(event,vgWin)
		{
		}
									...
									<div id="LayoutCol19" class="col col-12 c_LayoutCol19 card-header">
										<div id="Div2" runat="server" class="c_Div2 div-transparent">
											...
											<telerik:RadButton id="Button21" runat="server" ButtonType="SkinnedButton"
												...
												OnClientClicking="___Button21_OnClientClick" RenderMode="Lightweight" TabIndex="5" Text="<%$ Resources: Button21 %>">
												<ContentTemplate>
											...
											<telerik:RadButton id="Button19" runat="server" ButtonType="SkinnedButton"
												...
												OnClientClicking="___Button19_OnClientClick" RenderMode="Lightweight" TabIndex="10" Text="<%$ Resources: Button19 %>">
												<ContentTemplate>
									...
									<div id="LayoutCol20" class="col col-12 c_LayoutCol20 card-body">
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol2" class="col col-1 c_LayoutCol2">
												...
												<telerik:RadTextBox id="txtSupervisao" runat="server" AutoPostBack="False" CssClass="c_txtSupervisao textbox-default"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="11"
													onkeydown="___txtSupervisao_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="1" TextMode="SingleLine"
													UseTelerikMask="False" WrapperCssClass="c_txtSupervisao_wrapper" />
												<telerik:RadLabel id="Label13" runat="server" CssClass="c_Label13" IsValidationError="true" Text="<%$ Resources: Label13 %>" />
											</div>
											<div id="LayoutCol15" class="col col-7 c_LayoutCol15">
												<telerik:RadLabel id="Label19" runat="server" CssClass="c_Label19" Text="<%$ Resources: Label19 %>" />
												<telerik:RadTextBox id="txtNomeSupervisao" runat="server" AutoPostBack="False" CssClass="c_txtNomeSupervisao textbox-default"
													EnabledStyle-HorizontalAlign="Right" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="100"
													onkeydown="___txtNomeSupervisao_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="2" TextMode="SingleLine"
													UseTelerikMask="False" WrapperCssClass="c_txtNomeSupervisao_wrapper" />
											...
											<div id="LayoutCol10" class="col col-2 c_LayoutCol10">
												...
												<telerik:RadComboBox id="ComboBox4" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													...
													OnClientKeyPressing="Combo_HandleKeyPress" OnItemsRequested="___ComboBox4_OnItemsRequested" RenderMode="Lightweight" TabIndex="9" />
											</div>
												...
												<div id="LayoutRow5" class="row c_LayoutRow5">
													...
													<div id="LayoutCol23" class="col col-12 c_LayoutCol23">
														<telerik:RadGrid id="Grid1" runat="server" AllowCustomPaging="true" AllowFilteringByColumn="False" AllowPaging="True"
															AllowSorting="True" AutoGenerateColumns="false" CssClass="c_Grid1 grid-default" CleanLayoutNoRecord="False" EnableEmbeddedSkins="True"
															...
															<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="Celula,Supervisao,Distrito,Coordenacao" EditMode="InPlace">
																<Columns>
																	<telerik:GridBoundColumn UniqueName="GridColumn_Supervisao" runat="server" AllowFiltering="false" AutoPostBackOnFilter="False"
																		EnableHeaderContextMenu="True" Exportable="True" FilterDelay="2000" HeaderStyle-CssClass="c_GridColumn_Supervisao"
																		HeaderStyle-Width="429" HeaderText="<%$ Resources: GridColumn_Supervisao %>" ItemStyle-CssClass="c_GridColumn_Supervisao"
																		ItemStyle-Width="422" MaxLength="11" ReadOnly="true" ShowFilterIcon="True" ShowSortIcon="True" />
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#txtSupervisao').first().focus();", 200);
				}
			}
			catch (e)
			{
		...
		function Supervisao() { return document.getElementById('txtSupervisao').value; }
		function Supervisao_Nome() { return document.getElementById('txtNomeSupervisao').value; }
		...
		function LoadEditAuto() {
				$j("#txtSupervisao").bind("keydown", InitiateEditAuto);
				$j("#txtNomeSupervisao").bind("keydown", InitiateEditAuto);
