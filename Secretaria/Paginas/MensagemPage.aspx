<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.MensagemPage, App_Web_n0hzq5tm" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/MensagemPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       confirmButtonText:'Nova Mensagem' ,
		...
		<script type="text/javascript" src="../../JS/MensagemPage_USER.js?sv=4.0_20240325151747"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Secretaria/Paginas/MensagemPage.aspx?ParamMensagem={ParamMensagem}") %>';
			UrlPage = UrlPage.replace('{ParamMensagem}', '');
			NavigateBrowser(UrlPage);
		}
									...
									<div id="LayoutCol19" class="col col-12 c_LayoutCol19 card-header">
										<div id="Div2" runat="server" class="c_Div2 div-transparent">
											...
											<telerik:RadButton id="Button22" runat="server" ButtonType="SkinnedButton"
												...
												OnClientClicking="___Button22_OnClientClick" RenderMode="Lightweight" TabIndex="7" Text="<%$ Resources: Button22 %>">
												<ContentTemplate>
										...
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol3" class="col col-12 col-md-4 c_LayoutCol3">
												...
												<telerik:RadTextBox id="TxtNome" runat="server" AutoPostBack="False" CssClass="c_TxtNome textbox-default"
													data-validation-engine="validate[funcCall[TxtNome_Validation]]" data-validation-message="titulo não pode ser vazio!"
											...
											<div id="LayoutCol222" class="col col-12 col-md-3 c_LayoutCol222">
												...
												<telerik:RadTextBox id="RadTextBox23" runat="server" AutoPostBack="False" CssClass="c_RadTextBox23 textbox-default"
													data-validation-engine="validate[funcCall[RadTextBox23_Validation]]" data-validation-message="Autor não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="250"
													onkeydown="___RadTextBox23_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="5" TextMode="SingleLine"
											...
											<div id="LayoutCol223" class="col col-3 c_LayoutCol223">
												<telerik:RadLabel id="Label47" runat="server" CssClass="c_Label47" Text="<%$ Resources: Label47 %>" />
												<telerik:RadComboBox id="CBDistrito" runat="server" AllowCustomText="True" AutoPostBack="False" CssClass="c_CBDistrito combobox-primary"
													...
													OnItemsRequested="___CBDistrito_OnItemsRequested" RenderMode="Lightweight" TabIndex="9" />
												<telerik:RadCheckBox id="RadCheckBox1" runat="server" AutoPostBack="True" Checked="False"
													CssClass="RadCheckBox1 c_RadCheckBox1 checkbox-toggle-dark" RenderMode="Lightweight" TabIndex="10" Text="<%$ Resources: RadCheckBox1 %>"
													/>
											</div>
											<div id="LayoutCol21" class="col col-12 c_LayoutCol21">
												...
												<gas:GEditor id="GEditor1" runat="server" CssClass="c_GEditor1" EnableEmbeddedSkins="True" TabIndex="6" ViewMode="Design" />
											</div>
											<div id="LayoutCol221" class="col col-12 c_LayoutCol221">
												...
												<telerik:RadTextBox id="RadTextBox22" runat="server" AutoPostBack="False" CssClass="c_RadTextBox22 textbox-default"
													...
													onkeydown="___RadTextBox22_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="4" TextMode="MultiLine"
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function titulo() { return document.getElementById('TxtNome').value; }
		function Autor() { return document.getElementById('RadTextBox23').value; }
		function Data() { return document.getElementById('DatePicker1').value; }
		function Distrito() { return $find("<%= CBDistrito.ClientID %>").get_value(); }
		...
		function LoadEditAuto() {
				...
				$j("#CBDistrito").bind("change", InitiateEditAuto);
