<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaAvisosPage, App_Web_d5iscsap" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaAvisosPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/ListaAvisosPage_USER.js?sv=4.0_20240318185232"></script>
	...
	<script type="text/javascript">
		...
		{
			var UrlPage = '<%= ResolveUrl("~/Secretaria/Paginas/AvisosPage.aspx?ParamDataAviso={ParamDataAviso}") %>';
			UrlPage = UrlPage.replace('{ParamDataAviso}', '');
			NavigateBrowser(UrlPage);
			args.set_cancel(true);
			return false;
		}
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" EditMode="InPlace">
												<Columns>
													<telerik:GridBoundColumn UniqueName="GridColumn11" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														ConvertEmptyStringToNull="False" DataField="Distrito" DataFormatString="{0:###,###,##0}" EnableHeaderContextMenu="True"
														Exportable="True" FilterControlWidth="100%" FilterDelay="2000" FooterStyle-HorizontalAlign="Right" ForceExtractValue="Always"
														HeaderStyle-CssClass="c_GridColumn11" HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn11 %>" ItemStyle-CssClass="c_GridColumn11" ItemStyle-HorizontalAlign="Right" ItemStyle-Width="86"
