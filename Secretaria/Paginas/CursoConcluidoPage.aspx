<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.CursoConcluidoPage, App_Web_xaiz32po" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/CursoConcluidoPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/CursoConcluidoPage_USER.js?sv=4.0_20240403133350"></script>
	...
	<script type="text/javascript">
		...
		{
			ExecuteCommandRequest("New","","","continue:___Button23_OnClientClick_Action2");
			args.set_cancel(true);
			return false;
		}
						...
						<div id="LayoutRow1" class="row c_LayoutRow1">
							...
							<div id="LayoutCol2" class="col col-3 c_LayoutCol2">
								...
								<telerik:RadComboBox id="ComboBox1" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[ComboBox1_Validation]]" data-validation-message="codigoCurso não pode ser vazio!"
									...
									ForeColor="#A4ABB2" LoadingMessage="<%$ Resources: ComboBox1 %>" MarkFirstMatch="true" MaxHeight="300" OnClientBlur="___ComboBox1_OnBlur"
							...
							<div id="LayoutCol12" class="col col-4 c_LayoutCol12">
								...
								<telerik:RadComboBox id="CBRolMembro" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
									...
									data-validation-engine="validate[funcCall[CBRolMembro_Validation]]" data-validation-message="RolMembro não pode ser vazio!" enabled="false"
									EnableEmbeddedSkins="True" EnableLoadOnDemand="True" EnableVirtualScrolling="True" ExpandAnimation-Duration="300" ExpandAnimation-Type="None"
							...
							<div id="LayoutCol9" class="col col-2 c_LayoutCol9">
								...
								<telerik:RadDateTimePicker id="DatePicker1" runat="server" Calendar-ClientEvents-OnDateClick="HideDatePickerValidation"
									...
									DateInput-WrapperCssClass="c_DatePicker1_dateInput_wrapper" DatePickerType="DateTime" DatePopupButton-ToolTip="Select date"
									...
									TimeView-EndTime="23:00" TimeView-StartTime="00:00" Width="176" />
							</div>
									...
									<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="id" EditMode="InPlace">
										<Columns>
											<telerik:GridBoundColumn UniqueName="GridColumn1" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
												ConvertEmptyStringToNull="False" DataField="Curso" EnableHeaderContextMenu="True" Exportable="True" FilterControlWidth="58"
											...
											<telerik:GridDateTimeColumn UniqueName="GridColumn2" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
												...
												HeaderStyle-CssClass="c_GridColumn2" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn2 %>" ItemStyle-CssClass="c_GridColumn2"
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function codigoCurso() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
