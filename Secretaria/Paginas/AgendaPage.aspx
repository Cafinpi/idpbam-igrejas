<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.AgendaPage, App_Web_5m1112mp" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/AgendaPage.css" OrderIndex="1"/>
...
<script type="text/javascript">
	function sweetAlert_SweetAlert1(customMessage, customTitle, customPosition, sender)
	{
	   Swal.fire({
	       ...
	       text: customMessage === undefined ? 'Evento agendado com sucesso!' : customMessage,
	       showCloseButton:  false,
	       showCancelButton: true,
	       showConfirmButton:true,
	       confirmButtonText:'Novo Evento' ,
		...
		<script type="text/javascript" src="../../JS/AgendaPage_USER.js?sv=4.0_20240309131846"></script>
										...
										<div id="LayoutRow4" class="row c_LayoutRow4">
											<div id="LayoutCol224" class="col col-3 c_LayoutCol224">
												...
												<telerik:RadTextBox id="RadTextBox1" runat="server" AutoPostBack="False" CssClass="c_RadTextBox1 textbox-default"
													data-validation-engine="validate[funcCall[RadTextBox1_Validation]]" data-validation-message="Evento não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0"
													onkeydown="___RadTextBox1_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="3" TextMode="SingleLine"
											...
											<div id="LayoutCol222" class="col col-2 c_LayoutCol222">
												...
												<telerik:RadTextBox id="RadTextBox5" runat="server" AutoPostBack="False" CssClass="c_RadTextBox5 textbox-default"
													data-validation-engine="validate[funcCall[RadTextBox5_Validation]]" data-validation-message="Horario não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="5"
											...
											<div id="LayoutCol16" class="col col-2 c_LayoutCol16">
												...
												<telerik:RadTextBox id="RadTextBox3" runat="server" AutoPostBack="False" CssClass="c_RadTextBox3 textbox-default"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0"
													onkeydown="___RadTextBox3_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="6" TextMode="SingleLine"
													UseTelerikMask="False" WrapperCssClass="c_RadTextBox3_wrapper" />
											</div>
											<div id="LayoutCol225" class="col col-3 c_LayoutCol225">
												...
												<telerik:RadTextBox id="RadTextBox4" runat="server" AutoPostBack="False" CssClass="c_RadTextBox4 textbox-default"
													data-validation-engine="validate[funcCall[RadTextBox4_Validation]]" data-validation-message="Objetivo não pode ser vazio!"
													EnabledStyle-HorizontalAlign="Left" EnableSingleInputRendering="True" ForeColor="#333333" MaxLength="0"
													onkeydown="___RadTextBox4_onkeydown();" ReadOnly="False" RenderMode="Lightweight" TabIndex="9" TextMode="SingleLine"
											...
											<div id="LayoutCol223" class="col col-4 c_LayoutCol223">
												...
												<telerik:RadComboBox id="ComboBox2" runat="server" disable-data-validation-onblur AllowCustomText="False" AutoPostBack="False"
													...
													data-validation-engine="validate[funcCall[ComboBox2_Validation]]" data-validation-message="Publico não pode ser vazio!"
											...
											<div id="LayoutCol221" class="col col-4 c_LayoutCol221">
...
<telerik:RadCodeBlock ID="EndCodeBlock" runat="server">
	<script type="text/javascript">
		...
		function Evento() { return document.getElementById('RadTextBox1').value; }
		function Data() { return document.getElementById('DatePicker1').value; }
		function Horario() { return document.getElementById('RadTextBox5').value; }
		function Local() { return document.getElementById('RadTextBox3').value; }
		function Objetivo() { return document.getElementById('RadTextBox4').value; }
		function Publico() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function Distrito() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
		function Numero() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
