<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.TelaMembroCelulaPage, App_Web_pxx2opyb" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/TelaMembroCelulaPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/TelaMembroCelulaPage_USER.js?sv=4.0_20240309131845"></script>
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							...
							<div id="LayoutCol1" class="col col-6 col-md-4 col-lg-3 offset-0 offset-sm-0 offset-md-2 offset-lg-3 offset-xl-3 c_LayoutCol1">
								<telerik:RadButton id="Button1" runat="server" ButtonType="SkinnedButton"
									...
									<ContentTemplate>
										<span class="gvText">NOVO MEMBRO</span>
										<span class="fas fa-male c_Button1_icon gvIcon"></span>
									</ContentTemplate>
								</telerik:RadButton>
							</div>
							<div id="LayoutCol2" class="col col-6 col-md-4 col-lg-3 c_LayoutCol2">
								<telerik:RadButton id="Button2" runat="server" ButtonType="SkinnedButton"
									...
									<ContentTemplate>
										<span class="gvText">MEMBRO EXISTENTE</span>
