<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.ListaEventosPage, App_Web_pxx2opyb" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/ListaEventosPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/ListaEventosPage_USER.js?sv=4.0_20240309131841"></script>
											...
											<MasterTableView  AllowCustomPaging="true" CommandItemDisplay="Top" DataKeyNames="id" EditMode="InPlace">
												<Columns>
													<telerik:GridDateTimeColumn UniqueName="GridColumn13" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn13" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn13 %>"
														ItemStyle-CssClass="c_GridColumn13" ItemStyle-Width="86" MaxLength="8" PickerType="DatePicker" ReadOnly="False" ShowFilterIcon="True"
														ShowSortIcon="True" />
													<telerik:GridDateTimeColumn UniqueName="GridColumn14" runat="server" AllowFiltering="True" AllowSorting="true"
														AutoPostBackOnFilter="False" ConvertEmptyStringToNull="False" DataField="DataFim" DataFormatString="{0:dd/MM/yy}"
														EditDataFormatString="dd/MM/yy" EnableHeaderContextMenu="True" Exportable="True" FilterDateFormat="dd/MM/yy" FilterDelay="2000"
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn14" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn14 %>"
														ItemStyle-CssClass="c_GridColumn14" ItemStyle-Width="86" MaxLength="8" PickerType="DatePicker" ReadOnly="False" ShowFilterIcon="True"
														ShowSortIcon="True" />
													<telerik:GridBoundColumn UniqueName="GridColumn15" runat="server" AllowFiltering="True" AllowSorting="true" AutoPostBackOnFilter="False"
														...
														FilterDelay="2000" ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn15" HeaderStyle-Width="93"
														HeaderText="<%$ Resources: GridColumn15 %>" ItemStyle-CssClass="c_GridColumn15" ItemStyle-Width="86" MaxLength="300" ReadOnly="False"
													...
													<telerik:GridDateTimeColumn UniqueName="GridColumn19" runat="server" AllowFiltering="True" AllowSorting="true"
														...
														EditDataFormatString="dd/MM/yy" EnableHeaderContextMenu="True" Exportable="True" FilterDateFormat="dd/MM/yy" FilterDelay="2000"
														ForceExtractValue="Always" HeaderStyle-CssClass="c_GridColumn19" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn19 %>"
														ItemStyle-CssClass="c_GridColumn19" ItemStyle-Width="86" MaxLength="8" PickerType="DatePicker" ReadOnly="False" ShowFilterIcon="True"
														ShowSortIcon="True" />
													...
													<telerik:GridButtonColumn UniqueName="GridColumn17" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														...
														HeaderStyle-CssClass="c_GridColumn17" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn17 %>"
														ItemStyle-CssClass="c_GridColumn17" ItemStyle-Width="86" ShowFilterIcon="True" ShowSortIcon="True"
														Text="<%$ Resources: GridColumn17_1 %>" />
													<telerik:GridButtonColumn UniqueName="GridColumn18" runat="server" AutoPostBackOnFilter="False" ButtonType="PushButton"
														CommandName="GridColumn18" EnableHeaderContextMenu="True" Exportable="True" FilterDelay="2000" Groupable="false"
														HeaderStyle-CssClass="c_GridColumn18" HeaderStyle-Width="93" HeaderText="<%$ Resources: GridColumn18 %>"
														ItemStyle-CssClass="c_GridColumn18" ItemStyle-Width="86" ShowFilterIcon="True" ShowSortIcon="True"
														Text="<%$ Resources: GridColumn18_1 %>" />
