<%@ page language="C#" validaterequest="false" maintainscrollpositiononpostback="true" enableeventvalidation="True" autoeventwireup="true" inherits="PROJETO.DataPages.SelecionarSupervisorPage, App_Web_if5qibfo" culture="auto" uiculture="auto" %>
...
<head id="Head1" runat="server">
	...
	<telerik:RadStyleSheetManager runat="server" ID="styleSheetManager" EnableStyleSheetCombine="true" OutputCompression="AutoDetect">
		<StyleSheets>
			...
			<telerik:StyleSheetReference Path="~/Styles/SelecionarSupervisorPage.css" OrderIndex="1"/>
...
<body onload="InitializeClient();" id="Form1_body" style="margin-left:auto;margin-right:auto;">
	<telerik:RadCodeBlock ID="BodyCodeBlock" runat="server">
		...
		<script type="text/javascript" src="../../JS/SelecionarSupervisorPage_USER.js?sv=4.0_20240403133347"></script>
    ...
    <script type="text/javascript">
		...
		function ClientRefreshCombos(sender, args) 
		{
			...
			{
				case "ComboBox3":
					PrepareAndRequestItems(new Array("ComboBox2", "ComboBox1"));
					break;
				case "ComboBox2":
			...
			<telerik:RadAjaxPanel id="MainAjaxPanel" runat="server" class="c_MainAjaxPanel" ClientEvents-OnRequestStart="___Form1_OnRequestStart" ClientEvents-OnResponseEnd="___Form1_OnResponseEnd" LoadingPanelID="___Form1_AjaxLoading">
					<div id="LayoutContainer1" runat="server" class="container-fluid c_LayoutContainer1">
						<div id="LayoutRow1" class="row c_LayoutRow1">
							...
							<div id="LayoutCol4" class="col col-4 c_LayoutCol4">
								...
								<telerik:RadComboBox id="ComboBox3" runat="server" AllowCustomText="False" AutoPostBack="False" CssClass="c_ComboBox3 combobox-primary"
									...
									OnClientSelectedIndexChanged="ClientRefreshCombos" OnItemsRequested="___ComboBox3_OnItemsRequested" RenderMode="Lightweight" TabIndex="1" />
							</div>
							<div id="LayoutCol2" class="col col-4 c_LayoutCol2">
							...
							<div id="LayoutCol1" class="col col-4 c_LayoutCol1">
	...
	<script type="text/javascript">
		...
		function SetFocusFirstField()
		{
			try
			{
				{
					window.focus();
					setTimeout("var $j = jQuery.noConflict();$j('#ComboBox3_Input').first().focus();", 200);
				}
			}
			catch (e)
			{
		...
		function CBDistrito() { return $find("<%= ComboBox3.ClientID %>").get_value(); }
		function CBCoordenacao() { return $find("<%= ComboBox2.ClientID %>").get_value(); }
		function CBSupervisao() { return $find("<%= ComboBox1.ClientID %>").get_value(); }
