<%@ page language="C#" autoeventwireup="true" inherits="PROJETO.Reports.RelListaPresenteCelula, App_Web_4xkz2ztk" %>
<%@ Register TagPrefix="telerik" Assembly="Telerik.ReportViewer.Html5.WebForms" Namespace="Telerik.ReportViewer.Html5.WebForms" %>
<!DOCTYPE>
<html>
<head runat="server">
	<title>Relatório - Lista de Presentes Célula</title>
...
<body>
    <form runat="server" id="form1" style="min-width: 450px; min-height: 300px;">
        <telerik:ReportViewer Width="" Height="" EnableAccessibility="false" ScaleMode="Specific" ID="TelerikReportViewer1" runat="server" ParametersAreaPosition="Left" ClientEvents-PageReady="onReady">
            <ReportSource IdentifierType="UriReportSource" Identifier="RelListaPresenteCelula">
            </ReportSource>
